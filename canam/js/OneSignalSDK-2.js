! function(e) {
            ...
            return e.getBuildEnv = function() {
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                if (f.default.isSafari()) return [2, l.IntegrationKind.Secure];
                                if (n = window === window.top, i = "https:" === window.location.protocol, void 0 === t) {
                                    if ("undefined" == typeof OneSignal || !OneSignal.context || !OneSignal.context.appConfig) throw new c.InvalidArgumentError("usingProxyOrigin", c.InvalidArgumentReason.Empty);
                                    t = !!OneSignal.context.appConfig.subdomain
                                }
                                return n ? i ? [2, t ? l.IntegrationKind.SecureProxy : l.IntegrationKind.Secure] : !p.default.isLocalhostAllowedAsSecureOrigin() || "localhost" !== location.hostname && "127.0.0.1" !== location.hostname ? [2, l.IntegrationKind.InsecureProxy] : [2, l.IntegrationKind.Secure] : [3, 1];
                            case 1:
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(e) {
                        switch (e.label) {
                            case 0:
                                return window !== window.top && "serviceWorker" in navigator && void 0 !== navigator.serviceWorker.getRegistration ? [4, d.default.getRegistration()] : [2, !1];
                            case 1:
                                return [2, !e.sent()]
                        }
                    })
            ...
            return e.trigger = function(t, n, o) {
                return void 0 === o && (o = null), i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                if (l.default.contains(d, t) || (i = n, h = l.default.capitalize(a.default.getWindowEnv().toString()), o && (h = h + " â¬¸ " + l.default.capitalize(o)), i || !1 === i ? c.default.debug("(" + h + ") Â» %c" + t + ":", l.default.getConsoleStyle("event"), i) : c.default.debug("(" + h + ") Â» %c" + t, l.default.getConsoleStyle("event"))), !s.default.isBrowser()) return [3, 2];
                            ...
                            case 2:
                                return p.hasOwnProperty(t) && (g = p[t], e._triggerLegacy(g, n)), !s.default.isBrowser() || a.default.getWindowEnv() !== u.WindowEnvironmentKind.OneSignalSubscriptionPopup && a.default.getWindowEnv() !== u.WindowEnvironmentKind.OneSignalProxyFrame || (opener || parent ? l.default.contains(f, t) && (a.default.getWindowEnv() === u.WindowEnvironmentKind.OneSignalSubscriptionPopup ? OneSignal.subscriptionPopup.message(OneSignal.POSTMAM_COMMANDS.REMOTE_RETRIGGER_EVENT, {
                                    eventName: t,
                                    eventData: n
                                }) : OneSignal.proxyFrame.retriggerRemoteEvent(t, n)) : c.default.error("Could not send event '" + t + "' back to host page because no creator (opener or parent) found!")), [2]
                        }
                    })
                })
    ...
    function b() {
        return d.OneSignalUtils.redetectBrowserUserAgent()
    }

    function v() {
        return d.OneSignalUtils.isUsingSubscriptionWorkaround()
    }
    ...
    function S() {
        return l.default.warn("OneSignal: Unsubscribing from push."), a.default.getWindowEnv() !== u.WindowEnvironmentKind.ServiceWorker ? self.registration.pushManager.getSubscription().then(function(e) {
            if (e) return e.unsubscribe();
            throw new Error("Cannot unsubscribe because not subscribed.")
        }) : v() ? new Promise(function(e, t) {
            l.default.debug("Unsubscribe from push got called, and we're going to remotely execute it in HTTPS iFrame."), OneSignal.proxyFrameHost.message(OneSignal.POSTMAM_COMMANDS.UNSUBSCRIBE_FROM_PUSH, null, function(n) {
                l.default.debug("Unsubscribe from push succesfully remotely executed."), n.data === OneSignal.POSTMAM_COMMANDS.REMOTE_OPERATION_COMPLETE ? e() : t("Failed to remotely unsubscribe from push.")
            })
    ...
    function y() {
        return l.default.warn("OneSignal: Unregistering service worker."), a.default.getWindowEnv() === u.WindowEnvironmentKind.OneSignalProxyFrame ? Promise.resolve() : navigator.serviceWorker && navigator.serviceWorker.controller ? navigator.serviceWorker.ready.then(function(e) {
            return e.unregister()
        }) : Promise.resolve()
    }
    ...
    t.isArray = g, t.decodeHtmlEntities = function(e) {
        return p.BrowserUtils.decodeHtmlEntities(e)
    ...
    }, t.isLocalhostAllowedAsSecureOrigin = function() {
        return d.OneSignalUtils.isLocalhostAllowedAsSecureOrigin()
    }, t.awaitOneSignalInitAndSupported = function() {
        return i(this, void 0, void 0, function() {
            return r(this, function(e) {
        ...
        return void 0 === e && (e = !1), i(this, void 0, void 0, function() {
            return r(this, function(t) {
                return [2, f.PermissionUtils.triggerNotificationPermissionChanged(e)]
            })
        })
    }, t.stringify = function(e) {
        return h.Utils.stringify(e)
    }, t.executeCallback = function(e) {
        for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
        if (e) return e.apply(null, t)
    }, t.logMethodCall = function(e) {
        for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
        return d.OneSignalUtils.logMethodCall.apply(d.OneSignalUtils, [e].concat(t))
    ...
    }, t.getConsoleStyle = function(e) {
        return h.Utils.getConsoleStyle(e)
    }, t.delay = function(e) {
        return new Promise(function(t) {
            setTimeout(t, e)
        })
    }, t.nothing = m, t.timeoutPromise = function(e, t) {
        return h.Utils.timeoutPromise(e, t)
    }, t.when = function(e, t, n) {
        return void 0 === t && (t = m()), void 0 === n && (n = m()), e ? t : n
    }, t.contains = function(e, t) {
        return h.Utils.contains(e, t)
    }, t.trimUndefined = function(e) {
        return h.Utils.trimUndefined(e)
    }, t.getRandomUuid = function() {
        return d.OneSignalUtils.getRandomUuid()
    }, t.isValidUuid = function(e) {
        return d.OneSignalUtils.isValidUuid(e)
        ...
        return l.default.warn("OneSignal: Wiping IndexedDB data."), Promise.all([c.default.remove("Ids"), c.default.remove("NotificationOpened"), c.default.remove("Options")])
    }, t.capitalize = function(e) {
        return h.Utils.capitalize(e)
    }, t.unsubscribeFromPush = S, t.wipeServiceWorker = y, t.wipeServiceWorkerAndUnsubscribe = function() {
        return Promise.all([S(), y()])
    }, t.wait = function(e) {
        return new Promise(function(t) {
        ...
        if (void 0 === r && (r = !1), n || l.default.error("Cannot call on() with no event: ", n), i || l.default.error("Cannot call on() with no task: ", i), "string" == typeof t) {
    ...
    }, t.getSdkLoadCount = w, t.awaitSdkEvent = function(e, t) {
        return i(this, void 0, void 0, function() {
        ...
        return h.Utils.encodeHashAsUriComponent(e)
    }
}, function(e, t, n) {
    "use strict";
    ...
    var r = i(n(1)),
        ...
        a = function() {
            ...
            return e.isBrowser = function() {
                ...
                return e.isBrowser() && s.default.safari
            }, e.version = function() {
                return Number(150506)
    ...
    var r = i(n(98)),
        o = function() {
            ...
            }, e.encodeHashAsUriComponent = function(e) {
        ...
        var r = i(n(10)),
            ...
            c = function() {
                ...
                return t.getBaseUrl = function() {
                    ...
                    return !r.default.safari && ((!t.isLocalhostAllowedAsSecureOrigin() || "localhost" !== location.hostname && "127.0.0.1" !== location.hostname) && !(e !== s.WindowEnvironmentKind.Host && e !== s.WindowEnvironmentKind.CustomIframe || !OneSignal.config.subdomain && "http:" !== location.protocol))
                }, t.redetectBrowserUserAgent = function() {
                    return "" === r.default.name && "" === r.default.version ? r.default._detect(navigator.userAgent) : r.default
                }, t.isValidUuid = function(e) {
                    ...
                    for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
                    return a.default.debug("Called %c" + e + "(" + t.map(u.Utils.stringify).join(", ") + ")", u.Utils.getConsoleStyle("code"), ".")
                }, t
            }();
        t.OneSignalUtils = c, t.default = c
    }).call(this, n(70))
}, function(e, t, n) {
    "use strict";
    ...
    var m = function() {
        function e(e) {
            this.databaseName = e, this.emitter = new a.default, this.database = new u.default(this.databaseName)
        }
        return e.resetInstance = function() {
            e.databaseInstance = null
        }, Object.defineProperty(e, "singletonInstance", {
            get: function() {
                return e.databaseInstanceName || (e.databaseInstanceName = "ONE_SIGNAL_SDK_DB"), e.databaseInstance || (e.databaseInstance = new e(e.databaseInstanceName)), e.databaseInstance
            },
            enumerable: !0,
            configurable: !0
        }), e.applyDbResultFilter = function(e, t, n) {
            switch (e) {
                case "Options":
            ...
            return i(this, void 0, void 0, function() {
                ...
                return r(this, function(a) {
                    switch (a.label) {
                        case 0:
                            return g.default.getWindowEnv() !== p.WindowEnvironmentKind.ServiceWorker && b.default.isUsingSubscriptionWorkaround() && g.default.getTestEnv() === f.TestEnvironmentKind.None ? [4, new Promise(function(e) {
                                return i(s, void 0, void 0, function() {
                                    return r(this, function(i) {
                                        return OneSignal.proxyFrameHost.message(OneSignal.POSTMAM_COMMANDS.REMOTE_DATABASE_GET, [{
                                            table: t,
                                            key: n
                                        }], function(t) {
                                            var n = t.data[0];
                        ...
                        case 3:
                            return o = a.sent(), [2, e.applyDbResultFilter(t, n, o)]
                    }
                })
            })
                            ...
                            return [4, new Promise(function(e, s) {
                                return i(o, void 0, void 0, function() {
                                    return r(this, function(i) {
                                        switch (i.label) {
                                            case 0:
                                                return g.default.getWindowEnv() !== p.WindowEnvironmentKind.ServiceWorker && b.default.isUsingSubscriptionWorkaround() && g.default.getTestEnv() === f.TestEnvironmentKind.None ? (OneSignal.proxyFrameHost.message(OneSignal.POSTMAM_COMMANDS.REMOTE_DATABASE_PUT, [{
                                                    table: t,
                                                    keypath: n
                                                }], function(i) {
            ...
            return g.default.getWindowEnv() !== p.WindowEnvironmentKind.ServiceWorker && b.default.isUsingSubscriptionWorkaround() && g.default.getTestEnv() === f.TestEnvironmentKind.None ? new Promise(function(n, i) {
        ...
        }, e.prototype.getExternalUserId = function() {
            return i(this, void 0, void 0, function() {
                return r(this, function(e) {
                    switch (e.label) {
                        case 0:
                            return [4, this.get("Ids", "externalUserId")];
                        case 1:
                            return [2, e.sent()]
                    }
                })
            })
        }, e.prototype.setExternalUserId = function(e) {
            return i(this, void 0, void 0, function() {
                var t, n;
                return r(this, function(i) {
                    switch (i.label) {
                        case 0:
                            return t = "", (n = v.default.getValueOrDefault(e, t)) !== t ? [3, 2] : [4, this.remove("Ids", "externalUserId")];
                        case 1:
                            return i.sent(), [3, 4];
                        case 2:
                            return [4, this.put("Ids", {
                                type: "externalUserId",
                                id: n
                            })];
                        case 3:
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(t) {
                    switch (t.label) {
                        case 0:
                            return e.deviceId ? [4, this.put("Ids", {
                                type: "userId",
                                id: e.deviceId
                            })] : [3, 2];
                        case 1:
            ...
            return i(this, void 0, void 0, function() {
                ...
                return r(this, function(t) {
                    switch (t.label) {
                        ...
                        case 1:
                            return (e = t.sent()) ? [2, h.EmailProfile.deserialize(e)] : [2, new h.EmailProfile]
                    }
                })
            })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(t) {
                    return [2, Promise.all([e.singletonInstance.remove("Ids"), e.singletonInstance.remove("NotificationOpened"), e.singletonInstance.remove("Options")])]
                })
            })
        }, e.on = function() {
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(n) {
                    return [2, e.singletonInstance.emitter.on.apply(e.singletonInstance.emitter, t)]
                })
            })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(n) {
                    switch (n.label) {
                        case 0:
                            return [4, e.singletonInstance.setEmailProfile(t)];
                        case 1:
                            return [2, n.sent()]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(t) {
                    switch (t.label) {
                        case 0:
                            return [4, e.singletonInstance.getEmailProfile()];
                        case 1:
                            return [2, t.sent()]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(n) {
                    switch (n.label) {
                        case 0:
                            return [4, e.singletonInstance.setSubscription(t)];
                        case 1:
                            return [2, n.sent()]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(t) {
                    switch (t.label) {
                        case 0:
                            return [4, e.singletonInstance.getSubscription()];
                        case 1:
                            return [2, t.sent()]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(n) {
                    switch (n.label) {
                        case 0:
                            return [4, e.singletonInstance.setProvideUserConsent(t)];
                        case 1:
                            return [2, n.sent()]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(t) {
                    switch (t.label) {
                        case 0:
                            return [4, e.singletonInstance.getProvideUserConsent()];
                        case 1:
                            return [2, t.sent()]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(n) {
                    switch (n.label) {
                        case 0:
                            return [4, e.singletonInstance.setServiceWorkerState(t)];
                        case 1:
                            return [2, n.sent()]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(t) {
                    switch (t.label) {
                        case 0:
                            return [4, e.singletonInstance.getServiceWorkerState()];
                        case 1:
                            return [2, t.sent()]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(n) {
                    switch (n.label) {
                        case 0:
                            return [4, e.singletonInstance.setAppState(t)];
                        case 1:
                            return [2, n.sent()]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(t) {
                    switch (t.label) {
                        case 0:
                            return [4, e.singletonInstance.getAppState()];
                        case 1:
                            return [2, t.sent()]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(n) {
                    switch (n.label) {
                        case 0:
                            return [4, e.singletonInstance.setAppConfig(t)];
                        case 1:
                            return [2, n.sent()]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(t) {
                    switch (t.label) {
                        case 0:
                            return [4, e.singletonInstance.getAppConfig()];
                        case 1:
                            return [2, t.sent()]
                    }
                })
            })
        }, e.getExternalUserId = function() {
            return i(this, void 0, void 0, function() {
                return r(this, function(t) {
                    switch (t.label) {
                        case 0:
                            return [4, e.singletonInstance.getExternalUserId()];
                        case 1:
                            return [2, t.sent()]
                    }
                })
            })
        }, e.setExternalUserId = function(t) {
            return i(this, void 0, void 0, function() {
                return r(this, function(n) {
                    switch (n.label) {
                        case 0:
                            return [4, e.singletonInstance.setExternalUserId(t)];
                        case 1:
                            return n.sent(), [2]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(i) {
                    switch (i.label) {
                        case 0:
                            return [4, e.singletonInstance.remove(t, n)];
                        case 1:
                            return [2, i.sent()]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(i) {
                    switch (i.label) {
                        case 0:
                            return [4, e.singletonInstance.put(t, n)];
                        case 1:
                            return [2, i.sent()]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(i) {
                    switch (i.label) {
                        case 0:
                            return [4, e.singletonInstance.get(t, n)];
                        case 1:
                            return [2, i.sent()]
                    }
                })
    ...
    }, void 0 !== e && e.exports ? e.exports = i() : n(99)("bowser", i)
}, function(e, t, n) {
    "use strict";
    var i, r = this && this.__extends || (i = Object.setPrototypeOf || {
                __proto__: []
            ...
            return e.fixWordpressManifestIfMisplaced = function() {
                ...
                if (e && !(e.length <= 1))
                    for (var t = 0; t < e.length; t++) {
                        var n = e[t],
                            i = n.href;
                        if (b.Utils.contains(i, "gcm_sender_id")) {
                            var r = document.querySelector("head");
                            r.insertBefore(n, r.children[0]), d.default.info("OneSignal: Moved the WordPress push <manifest> to the first element in <head>.")
                        }
                    }
            }, e.getCurrentNotificationType = function() {
                return i(this, void 0, void 0, function() {
                    var e, t;
                    return r(this, function(n) {
                        switch (n.label) {
                            case 0:
                                return [4, OneSignal.context.permissionManager.getNotificationPermission(OneSignal.context.appConfig.safariWebId)];
                            case 1:
                                return (e = n.sent()) === p.NotificationPermission.Default ? [2, f.SubscriptionStateKind.Default] : e === p.NotificationPermission.Denied ? [2, h.OneSignalUtils.isUsingSubscriptionWorkaround() ? f.SubscriptionStateKind.Default : f.SubscriptionStateKind.NotSubscribed] : [4, OneSignal.context.subscriptionManager.isAlreadyRegisteredWithOneSignal()];
                            case 2:
                                return t = n.sent(), e === p.NotificationPermission.Granted && t ? [4, OneSignal.privateIsPushNotificationsEnabled()] : [3, 4];
                            case 3:
                                return [2, n.sent() ? f.SubscriptionStateKind.Subscribed : f.SubscriptionStateKind.MutedByApi];
                            case 4:
                                return [2, f.SubscriptionStateKind.Default]
                        }
                    })
                })
            }, e.getNotificationTypeFromOptIn = function(e) {
                return 1 == e || null == e ? f.SubscriptionStateKind.Subscribed : f.SubscriptionStateKind.MutedByApi
            }, e.wasHttpsNativePromptDismissed = function() {
                return "dismissed" === l.default.getItem("onesignal-notification-prompt")
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(n) {
                        switch (n.label) {
                            ...
                            case 2:
                                return t = n.sent(), e === t ? [3, 5] : [4, g.PermissionUtils.triggerNotificationPermissionChanged()];
                            case 3:
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 3:
                                if ((i = r.sent()).errors) throw d.default.error("API call %c" + n, b.Utils.getConsoleStyle("code"), "failed with:", i.errors), new Error("Failed to get notification icons.");
                                return [2, i]
                        }
                    })
                })
            }, e.getSlidedownPermissionMessageOptions = function() {
                var e = "We'd like to show you notifications for the latest news and updates.",
                    t = OneSignal.config.userConfig.promptOptions;
                return t ? t.slidedown ? {
                    autoPrompt: t.slidedown.autoPrompt,
                    actionMessage: t.slidedown.actionMessage || e,
                    acceptButtonText: t.slidedown.acceptButtonText || "Allow",
                    cancelButtonText: t.slidedown.cancelButtonText || "No Thanks"
                } : {
                    autoPrompt: !1,
                    actionMessage: t.actionMessage || e,
                    acceptButtonText: t.acceptButtonText || "Allow",
                    cancelButtonText: t.cancelButtonText || "No Thanks"
                } : {
                    autoPrompt: !1,
                    actionMessage: e,
    ...
    var a = s(n(5)),
        ...
        p = function() {
            function e(e, t, n) {
                ...
                this.emitter = new c.default, this.channel = new MessageChannel, this.messagePort = null, this.isListening = !1, this.isConnected = !1, this.replies = {}
            }
            return Object.defineProperty(e, "HANDSHAKE_MESSAGE", {
                ...
                l.default.debug("(Postmam) Called listen()."), this.isListening ? l.default.debug("(Postmam) Already listening for Postmam connections.") : a.default.isBrowser() && (this.isListening = !0, l.default.debug("(Postmam) Listening for Postmam connections.", this), window.addEventListener("message", this.onWindowMessagePostmanConnectReceived.bind(this)))
                ...
                if (t.data) {
                    ...
                    if (this.replies.hasOwnProperty(r)) !1 === this.replies[r].bind(window)(d) && delete this.replies[r];
                    else this.emitter.emit(o, d)
                } else l.default.debug("(" + u.default.getWindowEnv().toString() + ") Received an empty Postmam message:", t)
                ...
                if ("function" != typeof t) {
                    var i = {
                        id: f.OneSignalUtils.getRandomUuid(),
                        command: e,
                        data: t,
                        source: u.default.getWindowEnv().toString()
                    };
                    "function" == typeof n && (this.replies[i.id] = n), this.windowReference.postMessage(i, "*")
                } else l.default.debug("You passed a function to data, did you mean to pass null?")
                ...
                return "https://onesignal.com" === e || e === "https://" + (t || "") + ".onesignal.com" || e === "https://" + (t || "") + ".os.tc" || e === "https://" + (t || "") + ".os.tc:3001" || e === u.default.getOneSignalApiUrl().origin || "*" === this.receiveFromOrigin || d.Utils.contains(n, e)
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), (i = t.SubscriptionStateKind || (t.SubscriptionStateKind = {}))[i.Default = 0] = "Default", i[i.Subscribed = 1] = "Subscribed", i[i.MutedByApi = -2] = "MutedByApi", i[i.NotSubscribed = -10] = "NotSubscribed", i[i.TemporaryWebRecord = -20] = "TemporaryWebRecord", i[i.PermissionRevoked = -21] = "PermissionRevoked", i[i.PushSubscriptionRevoked = -22] = "PushSubscriptionRevoked", i[i.ServiceWorkerStatus403 = -23] = "ServiceWorkerStatus403", i[i.ServiceWorkerStatus404 = -24] = "ServiceWorkerStatus404"
}, function(e, t, n) {
    "use strict";
    var i;
    Object.defineProperty(t, "__esModule", {
    ...
    var s = o(n(10)),
        ...
        q = function() {
            ...
            return e.setDefaultNotificationUrl = function(e) {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 4:
                                ...
                                return s = new j.EmailProfile(o.emailId, e), t && t.emailAuthHash && (s.emailAuthHash = t.emailAuthHash), (a = !!o.emailId) && n.emailAuthRequired ? (u = s, [4, T.default.updateEmailRecord(n, s, i)]) : [3, 6];
                            case 5:
                                return u.emailId = r.sent(), [3, 8];
                            case 6:
                                return l = s, [4, T.default.createEmailRecord(n, s, i)];
                            case 7:
                                l.emailId = r.sent(), r.label = 8;
                            case 8:
                                return !i || a && o.emailId === s.emailId && o.emailAddress && s.emailAddress === o.emailAddress ? [3, 10] : [4, T.default.updatePlayer(n.appId, i, {
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(i) {
                        switch (i.label) {
                            ...
                            case 4:
                                return n = i.sent().deviceId, t.emailId ? n ? [4, T.default.logoutEmail(e, t, n)] : (F.default.warn(new d.NotSubscribedError(d.NotSubscribedReason.NoDeviceId)), [2]) : (F.default.warn(new d.NotSubscribedError(d.NotSubscribedReason.NoEmailSet)), [2]);
                            case 5:
            ...
            }, e.initializeConfig = function(t) {
                return i(this, void 0, void 0, function() {
                    var n;
                    return r(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return [4, (new G.default).getAppConfig(t)];
                            case 1:
                                return n = i.sent(), F.default.debug("OneSignal: Final web app config: %c" + JSON.stringify(n, null, 4), D.getConsoleStyle("code")), e.context = new C.default(n), e.config = e.context.appConfig, [2]
                        }
                    })
                })
            }, e.init = function(t) {
                return i(this, void 0, void 0, function() {
                    return r(this, function(n) {
                        switch (n.label) {
                            case 0:
                                return D.logMethodCall("init"), [4, S.default.polyfillSafariFetch()];
                            case 1:
                                return n.sent(), S.default.errorIfInitAlreadyCalled(), [4, e.initializeConfig(t)];
                            case 2:
                        ...
                        return i(this, void 0, void 0, function() {
                            ...
                            return r(this, function(n) {
                                switch (n.label) {
                                    ...
                                    case 4:
                                        return n.sent(), I.default.getWindowEnv() !== A.WindowEnvironmentKind.CustomIframe ? [3, 6] : [4, b.default.trigger(e.EVENTS.SDK_INITIALIZED)];
                                    case 5:
                                        return n.sent(), [3, 8];
                                    case 6:
                        ...
                        switch (i.label) {
                            case 0:
                                if (t || (t = {}), e.__isPopoverShowing) throw new l.InvalidStateError(l.InvalidStateReason.RedundantPermissionMessage, {
                                    permissionPromptType: M.PermissionPromptType.SlidedownPermissionMessage
                                });
                                return y.default.wasHttpsNativePromptDismissed() && !t.force ? (F.default.info(new f.default), [2]) : [4, e.privateGetNotificationPermission()];
                            case 1:
                                return i.sent() === k.NotificationPermission.Denied ? (F.default.info(new p.default(h.PushPermissionNotGrantedErrorReason.Blocked)), [2]) : [4, e.privateIsPushNotificationsEnabled()];
                            case 2:
                                if (i.sent()) throw new u.default;
                                return [4, e.privateGetSubscription()];
                            case 3:
                                if (!i.sent()) throw new d.NotSubscribedError(d.NotSubscribedReason.OptedOut);
                                return y.default.markHttpPopoverShown(), [4, e.context.dynamicResourceLoader.loadSdkStylesheet()];
                            case 4:
                                return 0 !== i.sent() ? (F.default.debug("Not showing slidedown permission message because styles failed to load."), [2]) : (n = y.default.getSlidedownPermissionMessageOptions(), e.popover = new N.default(n), [4, e.popover.create()]);
                            case 5:
                                return i.sent(), F.default.debug("Showing the HTTP popover."), e.notifyButton && e.notifyButton.options.enable && "hidden" !== e.notifyButton.launcher.state && e.notifyButton.launcher.waitUntilShown().then(function() {
                                    ...
                                    e.popover.close(), F.default.debug("Setting flag to not show the popover to the user again."), O.default.markHttpsNativePromptDismissed(), e.registerForPushNotifications({
                                        autoAccept: !0
                                    })
                                }), e.emitter.once(N.default.EVENTS.CANCEL_CLICK, function() {
                                    F.default.debug("Setting flag to not show the popover to the user again."), O.default.markHttpsNativePromptDismissed()
                                }), [2]
                        }
                    })
                })
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    function o() {
                        return i(this, void 0, void 0, function() {
                            ...
                            return r(this, function(n) {
                                switch (n.label) {
                                    case 0:
                                        return t && t.httpPermissionRequest && z.default.isUsingSubscriptionWorkaround() ? (F.default.error(new B.DeprecatedApiError(B.DeprecatedApiReason.HttpPermissionRequest)), [2]) : z.default.isUsingSubscriptionWorkaround() ? [4, S.default.loadSubscriptionPopup(t)] : [3, 2];
                                    case 1:
                                        return n.sent(), [3, 6];
                                    case 2:
                                        return s.default.safari && Number(s.default.version) >= 12.1 ? [4, w.default.internalRegisterForPush(!1)] : [3, 4];
                                    case 3:
                                        return n.sent(), [3, 6];
                                    case 4:
                                        return (e = t || {}).__fromRegister = !0, [4, S.default.sessionInit(e)];
                                    case 5:
                                        n.sent(), n.label = 6;
                                    case 6:
                                        return [2]
                    ...
                    return r(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return e.initialized ? [3, 2] : [4, new Promise(function(t, s) {
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 3:
                                return (n = r.sent().deviceId) ? [4, T.default.getPlayer(t, n)] : (F.default.info(new d.NotSubscribedError(d.NotSubscribedReason.NoDeviceId)), [2, null]);
                            case 4:
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 3:
                                return (o = r.sent()).emailId ? [4, T.default.updatePlayer(i, o.emailId, {
                                    tags: t,
                            ...
                            case 8:
                                return [4, x.default.getSubscription()];
                            case 9:
                                return s = r.sent().deviceId, [4, T.default.updatePlayer(i, s, {
                                    tags: t
                                })];
                            case 10:
                    ...
                    return r(this, function(n) {
                        switch (n.label) {
                            case 0:
                                return [4, D.awaitOneSignalInitAndSupported()];
                            case 1:
                                return n.sent(), D.logMethodCall("setExternalUserId"), [4, this.context.subscriptionManager.isAlreadyRegisteredWithOneSignal()];
                            case 2:
                                return n.sent() ? [3, 4] : [4, D.awaitSdkEvent(e.EVENTS.REGISTERED)];
                            case 3:
                                n.sent(), n.label = 4;
                            case 4:
                                return [4, Promise.all([e.database.setExternalUserId(t), e.context.updateManager.sendExternalUserIdUpdate(t)])];
                            case 5:
                                return n.sent(), [2]
                        }
                    })
                    ...
                    return r(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return [4, D.awaitOneSignalInitAndSupported()];
                            case 1:
                                return t.sent(), D.logMethodCall("getExternalUserId"), [4, e.database.getExternalUserId()];
                            case 2:
                                return [2, t.sent()]
                        }
                    })
                })
            }, e.removeExternalUserId = function() {
                return i(this, void 0, void 0, function() {
                    return r(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return [4, D.awaitOneSignalInitAndSupported()];
                            case 1:
                                return t.sent(), D.logMethodCall("removeExternalUserId"), [4, this.context.subscriptionManager.isAlreadyRegisteredWithOneSignal()];
                            case 2:
                                return t.sent() ? [4, Promise.all([e.database.setExternalUserId(void 0), e.context.updateManager.sendExternalUserIdUpdate(void 0)])] : (F.default.warn("User is not subscribed, cannot remove external user id."), [2]);
                            case 3:
                                return t.sent(), [2]
                        }
                    })
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 3:
                                ...
                                return o ? (i.optedOut = !e, [4, T.default.updatePlayer(n, o, {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 4:
                                ...
                                return [4, T.default.sendNotification(i.appId, [f.deviceId], {
                                    en: t
                                }, {
                                    en: n
                                }, o, s, a, u)];
    ...
    t.default = q, q.VERSION = a.default.version(), q._VERSION = a.default.version(), q.sdkEnvironment = I.default, q._notificationOpenedCallbacks = [], q._idsAvailable_callback = [], q._defaultLaunchURL = null, q.config = null, q.__isPopoverShowing = !1, q._sessionInitAlreadyRunning = !1, q._isNotificationEnabledCallback = [], q._subscriptionSet = !0, q.modalUrl = null, q._windowWidth = 650, q._windowHeight = 568, q._isNewVisitor = !1, q._channel = null, q.timedLocalStorage = L.default, q.initialized = !1, q.notifyButton = null, q.store = _.default, q.environment = a.default, q.database = x.default, q.event = b.default, q.browser = s.default, q.popover = null, q.log = F.default, q.api = T.default, q.indexedDb = R.default, q.mainHelper = y.default, q.subscriptionHelper = w.default, q.httpHelper = m.default, q.eventHelper = v.default, q.initHelper = S.default, q.testHelper = O.default, q.appConfig = null, q.emitter = new H.default, q.SERVICE_WORKER_UPDATER_PATH = "OneSignalSDKUpdaterWorker.js", q.SERVICE_WORKER_PATH = "OneSignalSDKWorker.js", q.SERVICE_WORKER_PARAM = {
        scope: "/"
    }, q._LOGGING = !1, q.LOGGING = !1, q._usingNativePermissionHook = !1, q._initCalled = !1, q.__initAlreadyCalled = !1, q.checkAndWipeUserSubscription = function() {}, q.DeviceRecord = U.DeviceRecord, q.EmailDeviceRecord = K.EmailDeviceRecord, q.notificationPermission = k.NotificationPermission, q._initHttp = m.default.initHttp, q._initPopup = function() {
        return q.subscriptionPopup.subscribe()
    }, q.POSTMAM_COMMANDS = {
        CONNECTED: "connect",
    ...
    var h = function() {
        function e(e, t) {
            void 0 === t && (t = new p), this.context = e, this.replies = t
        }
    ...
    var a = n(63),
        ...
        d = function() {
            function e() {}
            return e.getPlayer = function(e, t) {
                return l.default.enforceAppId(e), l.default.enforcePlayerId(t), c.default.get("players/" + t + "?app_id=" + e)
            }, e.updatePlayer = function(e, t, n) {
                return l.default.enforceAppId(e), l.default.enforcePlayerId(t), c.default.put("players/" + t, i({
                    app_id: e
                }, n))
            }, e.sendNotification = function(e, t, n, i, r, o, s, a) {
                var u = {
                    app_id: e,
                    contents: i,
                ...
                return n && (u.headings = n), r && (u.url = r), o && (u.chrome_web_icon = o, u.firefox_icon = o), l.default.trimUndefined(u), c.default.post("notifications", u)
            }, e.createUser = function(e) {
                return r(this, void 0, void 0, function() {
                    var t, n;
                    return o(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return t = e.serialize(), l.default.enforceAppId(t.app_id), [4, c.default.post("players", t)];
                            case 1:
                                return (n = i.sent()) && n.success ? [2, n.id] : [2, null]
                        }
                    })
                })
            }, e.createEmailRecord = function(e, t, n) {
                return r(this, void 0, void 0, function() {
                    var i, r;
                    return o(this, function(o) {
                        switch (o.label) {
                            case 0:
                                return l.default.enforceAppId(e.appId), (i = new u.EmailDeviceRecord(t.emailAddress, t.emailAuthHash, n)).appId = e.appId, [4, c.default.post("players", i.serialize())];
                            case 1:
                                return (r = o.sent()) && r.success ? [2, r.id] : [2, null]
                        }
                    })
                })
            }, e.updateEmailRecord = function(e, t, n) {
                return r(this, void 0, void 0, function() {
                    var i, r;
                    return o(this, function(o) {
                        switch (o.label) {
                            case 0:
                                return l.default.enforceAppId(e.appId), l.default.enforcePlayerId(t.emailId), (i = new u.EmailDeviceRecord(t.emailAddress, t.emailAuthHash, n)).appId = e.appId, [4, c.default.put("players/" + t.emailId, i.serialize())];
                            case 1:
                                return (r = o.sent()) && r.success ? [2, r.id] : [2, null]
                        }
                    })
                })
            }, e.logoutEmail = function(e, t, n) {
                return r(this, void 0, void 0, function() {
                    var i;
                    return o(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return l.default.enforceAppId(e.appId), l.default.enforcePlayerId(n), [4, c.default.post("players/" + n + "/email_logout", {
                                    app_id: e.appId,
                                    parent_player_id: t.emailId,
                                    email_auth_hash: t.emailAuthHash ? t.emailAuthHash : void 0
                                })];
                            case 1:
                                return (i = r.sent()) && i.success ? [2, !0] : [2, !1]
                        }
                    })
                })
            }, e.updateUserSession = function(e, t) {
                return r(this, void 0, void 0, function() {
                    var n, i, r;
                    return o(this, function(o) {
                        switch (o.label) {
                            case 0:
                                return o.trys.push([0, 2, , 3]), n = t.serialize(), l.default.enforceAppId(n.app_id), l.default.enforcePlayerId(e), [4, c.default.post("players/" + e + "/on_session", n)];
                            case 1:
                                return (i = o.sent()).id ? [2, i.id] : [2, e];
                            case 2:
                                throw (r = o.sent()) && Array.isArray(r.errors) && r.errors.length > 0 && l.default.contains(r.errors[0], "app_id not found") ? new a.OneSignalApiError(a.OneSignalApiErrorKind.MissingAppId) : r;
                            case 3:
                                return [2]
                        }
                    })
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(n) {
                        switch (n.label) {
                            ...
                            case 1:
                                return t = n.sent(), [4, e.internalRegisterForPush(t)];
                            case 2:
                                return [2, n.sent()]
                        }
                    })
                })
            }, e.internalRegisterForPush = function(e) {
                return i(this, void 0, void 0, function() {
                    var t, n, i, o, g, b, v;
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                if (t = OneSignal.context, e && !t.sessionManager.isFirstPageView()) return f.default.debug("Not registering for push because the user is subscribed and this is not the first page view."), [2, null];
                                if ("undefined" != typeof OneSignal) {
                                    if (OneSignal._isRegisteringForPush) return [2, null];
                                    OneSignal._isRegisteringForPush = !0
                                }
                                switch (p.default.getWindowEnv()) {
                                    case u.WindowEnvironmentKind.Host:
                                ...
                                return [3, 20];
                            case 1:
                                return r.trys.push([1, 6, , 7]), [4, t.subscriptionManager.subscribe(0)];
                            case 2:
                                return i = r.sent(), [4, t.subscriptionManager.registerSubscription(i)];
                            case 3:
                                return n = r.sent(), t.sessionManager.incrementPageViewCount(), [4, h.PermissionUtils.triggerNotificationPermissionChanged()];
                            case 4:
                                return r.sent(), [4, c.default.checkAndTriggerSubscriptionChanged()];
                            case 5:
                                return r.sent(), [3, 7];
                            case 6:
                                return o = r.sent(), f.default.info(o), [3, 7];
                            case 7:
                                return [3, 21];
                            case 8:
                                return g = opener || parent, b = void 0, [4, t.permissionManager.updateStoredPermission()];
                            case 9:
                                r.sent(), r.label = 10;
                            case 10:
                                return r.trys.push([10, 13, , 19]), [4, t.subscriptionManager.subscribe(1)];
                            case 11:
                                return b = r.sent(), [4, t.permissionManager.updateStoredPermission()];
                            case 12:
                                return r.sent(), [3, 19];
                            case 13:
                                return v = r.sent(), [4, t.permissionManager.updateStoredPermission()];
                            case 14:
                                if (r.sent(), !(v instanceof s.default)) return [3, 18];
                                switch (v.reason) {
                            ...
                            case 16:
                                return r.sent(), OneSignal.subscriptionPopup.message(OneSignal.POSTMAM_COMMANDS.REMOTE_NOTIFICATION_PERMISSION_CHANGED, {
                                    permission: d.NotificationPermission.Denied,
                            ...
                            case 17:
                                return OneSignal.subscriptionPopup.message(OneSignal.POSTMAM_COMMANDS.REMOTE_NOTIFICATION_PERMISSION_CHANGED, {
                                    permission: d.NotificationPermission.Default,
                                    forceUpdatePermission: !0
                                }), [3, 18];
                            case 18:
                                return g ? (window.close(), [2, null]) : [3, 19];
                            case 19:
                                return OneSignal.subscriptionPopup.message(OneSignal.POSTMAM_COMMANDS.FINISH_REMOTE_REGISTRATION, {
                                    rawPushSubscription: b.serialize()
                                }, function(e) {
                                    !0 === e.data.progress ? (f.default.debug("Got message from host page that remote reg. is in progress, closing popup."), g && window.close()) : f.default.debug("Got message from host page that remote reg. could not be finished.")
                                }), [3, 21];
                            case 20:
                                throw "undefined" != typeof OneSignal && (OneSignal._isRegisteringForPush = !1), new l.InvalidStateError(l.InvalidStateReason.UnsupportedEnvironment);
                            case 21:
                                return "undefined" != typeof OneSignal && (OneSignal._isRegisteringForPush = !1), [2, n]
                        }
                    })
                })
            }, e
    ...
    var s = o(n(9)),
        ...
        u = function() {
            function e() {}
            return e.triggerNotificationPermissionChanged = function(e) {
                return void 0 === e && (e = !1), i(this, void 0, void 0, function() {
                    var t, n;
                    return r(this, function(i) {
                        switch (i.label) {
                            ...
                            case 1:
                                return t = i.sent(), [4, s.default.get("Options", "notificationPermission")];
                            case 2:
                                return n = i.sent(), t !== n || e ? [4, s.default.put("Options", {
                                    key: "notificationPermission",
                                    value: t
                                })] : [2];
                            case 3:
                                return i.sent(), a.default.trigger(OneSignal.EVENTS.NATIVE_PROMPT_PERMISSIONCHANGED, {
                                    to: t
                                }), [2]
                        }
                    })
            ...
            return e.getRegistration = function() {
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return t.trys.push([0, 2, , 3]), [4, navigator.serviceWorker.getRegistration(location.href)];
                            case 1:
                                return [2, t.sent()];
                            case 2:
                                return e = t.sent(), a.default.warn("[Service Worker Status] Error Checking service worker registration", location.href, e), [2, null];
                            case 3:
                                return [2]
                        }
                    })
                ...
                return new URL(i, c.OneSignalUtils.getBaseUrl()).href
            }, e
        }();
    t.default = l, (s = t.ServiceWorkerActiveState || (t.ServiceWorkerActiveState = {})).WorkerA = "Worker A (Main)", s.WorkerB = "Worker B (Updater)", s.ThirdParty = "3rd Party", s.Installing = "Installing", s.None = "None", s.Bypassed = "Bypassed", s.Indeterminate = "Indeterminate"
}, function(e, t, n) {
    "use strict";
    var i;
    Object.defineProperty(t, "__esModule", {
            ...
            return e.getRegistration = function() {
                return i(this, void 0, void 0, function() {
                    return r(this, function(e) {
                        switch (e.label) {
                            case 0:
                                return [4, y.default.getRegistration()];
                            case 1:
                                return [2, e.sent()]
                        }
                    })
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 1:
                                return (t = r.sent()) !== p.IntegrationKind.InsecureProxy ? [3, 2] : [2, y.ServiceWorkerActiveState.Indeterminate];
                            case 2:
                                if (t !== p.IntegrationKind.SecureProxy) return [3, 8];
                                switch (n = l.default.getWindowEnv(), n) {
                                    case h.WindowEnvironmentKind.Host:
                                    case h.WindowEnvironmentKind.CustomIframe:
                                        return [3, 3];
                                    case h.WindowEnvironmentKind.OneSignalSubscriptionPopup:
                                        return [3, 6];
                                    case h.WindowEnvironmentKind.OneSignalSubscriptionModal:
                                        return [3, 7]
                                }
                                return [3, 8];
                            case 3:
                                return (i = OneSignal.proxyFrameHost) ? [3, 4] : [2, y.ServiceWorkerActiveState.Indeterminate];
                            case 4:
                        ...
                        return [2, new Promise(function(t) {
                            return i(e, void 0, void 0, function() {
                                ...
                                return r(this, function(i) {
                                    switch (i.label) {
                                        case 0:
                                            return S.default.isUsingSubscriptionWorkaround() ? (e = OneSignal.proxyFrameHost) ? [3, 1] : (t(NaN), [3, 3]) : [3, 4];
                                        case 1:
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(t) {
                        switch (t.label) {
                            ...
                            case 1:
                                return (e = t.sent()) !== y.ServiceWorkerActiveState.WorkerA && e !== y.ServiceWorkerActiveState.WorkerB ? [2, !0] : [2, !1]
                        }
                    })
                })
                    ...
                    return r(this, function(n) {
                        switch (n.label) {
                            case 0:
                                return [4, this.getActiveState()];
                            case 1:
                                if ((e = n.sent()) !== y.ServiceWorkerActiveState.WorkerA && e !== y.ServiceWorkerActiveState.WorkerB) throw new a.InvalidStateError(a.InvalidStateReason.ServiceWorkerNotActivated);
                                return [2, new Promise(function(e) {
                                    t.context.workerMessenger.once(u.WorkerMessengerCommand.Subscribe, function(t) {
                                        e(d.Subscription.deserialize(t))
                                    }), t.context.workerMessenger.unicast(u.WorkerMessengerCommand.Subscribe, t.context.appConfig)
                                })]
                        }
                    })
                })
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(n) {
                        switch (n.label) {
                            ...
                            case 1:
                                e = n.sent(), b.default.info("[Service Worker Update] Checking service worker version..."), n.label = 2;
                            case 2:
                                return n.trys.push([2, 4, , 5]), [4, w.Utils.timeoutPromise(this.getWorkerVersion(), 2e3)];
                            case 3:
                                return t = n.sent(), [3, 5];
                            case 4:
                                return n.sent(), b.default.info("[Service Worker Update] Worker did not reply to version query; assuming older version."), t = 1, [3, 5];
                            case 5:
                                return e !== y.ServiceWorkerActiveState.WorkerA && e !== y.ServiceWorkerActiveState.WorkerB ? (b.default.debug("[Service Worker Update] Not updating service worker, current active worker state is " + e + "."), [2]) : t === s.default.version() ? [3, 7] : (b.default.info("[Service Worker Update] Updating service worker from v" + t + " --\x3e v" + s.default.version() + "."), [4, this.installWorker()]);
                            case 6:
                                return n.sent(), [3, 8];
                            case 7:
                                b.default.info("[Service Worker Update] Service worker version is current at v" + t + " (no update required)."), n.label = 8;
                            case 8:
                                return [2]
                        }
                    })
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(n) {
                        switch (n.label) {
                                        ...
                                        return r(this, function(s) {
                                            switch (s.label) {
                                                case 0:
                                                    return [4, this.getActiveState()];
                                                case 1:
                                                    return t = s.sent(), e !== t && t !== y.ServiceWorkerActiveState.Installing ? n() : navigator.serviceWorker.addEventListener("controllerchange", function(t) {
                                                        return i(o, void 0, void 0, function() {
                                                            var t;
                                                            return r(this, function(i) {
                                                                switch (i.label) {
                                                                    case 0:
                                                                        return [4, this.getActiveState()];
                                                                    case 1:
                                                                        return (t = i.sent()) !== e && t !== y.ServiceWorkerActiveState.Installing && n(), [2]
                                                                }
                                                            })
                                                        })
                                                    }), [2]
                            ...
                            case 4:
                                return n.sent() !== y.ServiceWorkerActiveState.WorkerB ? [3, 6] : [4, this.installAlternatingWorker()];
                            case 5:
                                n.sent(), n.label = 6;
                            case 6:
                ...
                return i(this, void 0, void 0, function() {
                    var e, t = this;
                    return r(this, function(n) {
                        return (e = this.context.workerMessenger).off(), e.on(u.WorkerMessengerCommand.NotificationDisplayed, function(e) {
                            b.default.debug(location.origin, "Received notification display event from service worker."), v.default.trigger(OneSignal.EVENTS.NOTIFICATION_DISPLAYED, e)
                        }), e.on(u.WorkerMessengerCommand.NotificationClicked, function(e) {
                            return i(t, void 0, void 0, function() {
                                var t, n;
                                return r(this, function(i) {
                                    switch (i.label) {
                                        case 0:
                                            return l.default.getWindowEnv() !== h.WindowEnvironmentKind.OneSignalProxyFrame ? [3, 2] : [4, new Promise(function(e) {
                                        ...
                                        case 3:
                                            return 0 !== t ? [3, 5] : (b.default.debug("notification.clicked event received, but no event listeners; storing event in IndexedDb for later retrieval."), n = e.url, e.url || (n = location.href), [4, f.default.put("NotificationOpened", {
                                                url: n,
                                                data: e,
                                                timestamp: Date.now()
                                            })]);
                                        case 4:
                                            return i.sent(), [3, 6];
                                        case 5:
                                            v.default.trigger(OneSignal.EVENTS.NOTIFICATION_CLICKED, e), i.label = 6;
                                        case 6:
                                            return [2]
                                    }
                                })
                            })
                        }), e.on(u.WorkerMessengerCommand.RedirectPage, function(e) {
                            b.default.debug(l.default.getWindowEnv().toString() + " Picked up command.redirect to " + e + ", forwarding to host page.");
                            var t = OneSignal.proxyFrame;
                            t && t.messenger.message(OneSignal.POSTMAM_COMMANDS.SERVICEWORKER_COMMAND_REDIRECT, e)
                        }), e.on(u.WorkerMessengerCommand.NotificationDismissed, function(e) {
                            v.default.trigger(OneSignal.EVENTS.NOTIFICATION_DISMISSED, e)
                        }), [2]
                    })
                })
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return [4, this.getActiveState()];
                            case 1:
                                return (t = r.sent()) !== y.ServiceWorkerActiveState.ThirdParty ? [3, 4] : [4, e.getRegistration()];
                            case 2:
                                return (n = r.sent()) ? [4, n.unregister()] : [3, 4];
                            case 3:
                                r.sent(), r.label = 4;
                            case 4:
                                i = y.default.getServiceWorkerHref(t, this.config), o = w.Utils.encodeHashAsUriComponent({
                                    appId: this.context.appConfig.appId
                                }), s = i + "?" + o, b.default.info("[Service Worker Installation] Installing service worker " + s + "."), r.label = 5;
                            case 5:
                                return r.trys.push([5, 7, , 9]), [4, navigator.serviceWorker.register(s, {
                                    scope: "" + S.default.getBaseUrl() + this.config.registrationOptions.scope
                                })];
                            case 6:
                                return r.sent(), [3, 9];
                            case 7:
                                if (a = r.sent(), b.default.error("[Service Worker Installation] Installing service worker failed " + a), l.default.getWindowEnv() === h.WindowEnvironmentKind.OneSignalSubscriptionPopup) throw a;
                                return [4, fetch(s)];
                            case 8:
                                if (403 === (u = r.sent()).status || 404 === u.status) throw new m.default(u.status, u.statusText);
                                throw a;
                            case 9:
                                return b.default.debug("[Service Worker Installation] Service worker installed."), [2]
                        }
                    })
                })
            }, e
    ...
    var r = i(n(5)),
        ...
        u = function() {
            ...
            return e.get = function(t, n, i) {
            ...
            }, e.call = function(t, n, i, s) {
                if ("GET" === t) {
                    if (n.indexOf("players") > -1 && -1 === n.indexOf("app_id=")) return console.error("Calls to player api are not permitted without app_id"), Promise.reject(new a.OneSignalApiError(a.OneSignalApiErrorKind.MissingAppId))
                } else if (n.indexOf("players") > -1 && (!i || !i.app_id)) return console.error("Calls to player api are not permitted without app_id"), Promise.reject(new a.OneSignalApiError(a.OneSignalApiErrorKind.MissingAppId));
                var u = new Headers;
                if (u.append("SDK-Version", "onesignal/web/" + r.default.version()), u.append("Content-Type", "application/json;charset=UTF-8"), s)
                ...
                return i && (p.body = JSON.stringify(i)), fetch(o.default.getOneSignalApiUrl().toString() + "/" + n, p).then(function(e) {
                ...
                var t = e.errors;
                return s.Utils.contains(t, "No user with this id found") || s.Utils.contains(t, "Could not find app_id for given player id.") ? "no-user-id-error" : "unknown-error"
            }, e
        }();
    t.OneSignalApiBase = u, t.default = u
}, function(e, t, n) {
    "use strict";
    var i = this && this.__importDefault || function(e) {
        return e && e.__esModule ? e : {
    ...
    var r = i(n(10)),
        ...
        l = function() {
            ...
            return e.prototype.getDevicePlatform = function() {
                ...
                var e = c.OneSignalUtils.redetectBrowserUserAgent();
            ...
            return e.onNotificationPermissionChange = function() {
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return f.OneSignalUtils.logMethodCall("checkAndTriggerSubscriptionChanged"), [4, OneSignal.context.subscriptionManager.getSubscriptionState()];
                            case 1:
                                return t = r.sent(), [4, OneSignal.privateIsPushNotificationsEnabled()];
                            case 2:
                                return n = r.sent(), [4, c.default.getAppState()];
                            case 3:
                                return i = r.sent(), o = i.lastKnownPushEnabled, null === o || n !== o ? (l.default.info("The user's subscription state changed from " + (null === o ? "(not stored)" : o) + " âŸ¶ " + t.subscribed), i.lastKnownPushEnabled = n, [4, c.default.setAppState(i)]) : [2];
                            case 4:
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return OneSignal.__doNotShowWelcomeNotification ? (l.default.debug("Not showing welcome notification because user has previously subscribed."), [2]) : !0 !== e ? [3, 3] : [4, c.default.getSubscription()];
                            case 1:
                                return t = r.sent().deviceId, [4, c.default.getAppConfig()];
                            case 2:
                                n = r.sent().appId, i = OneSignal.config.userConfig.welcomeNotification, o = void 0 !== i && !0 === i.disable, a = void 0 !== i && void 0 !== i.title && null !== i.title ? i.title : "", d = void 0 !== i && void 0 !== i.message && null !== i.message && i.message.length > 0 ? i.message : "Thanks for subscribing!", f = new URL(location.href).origin + "?_osp=do_not_open", h = i && i.url && i.url.length > 0 ? i.url : f, a = p.BrowserUtils.decodeHtmlEntities(a), d = p.BrowserUtils.decodeHtmlEntities(d), o || (l.default.debug("Sending welcome notification."), u.default.sendNotification(n, [t], {
                                    en: a
                                }, {
                                    en: d
                                }, h, null, {
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return OneSignal.config.userConfig.notifyButton ? (e = OneSignal.config.userConfig.notifyButton.displayPredicate) && "function" == typeof e && OneSignal.notifyButton ? [4, e()] : [3, 2] : [2];
                            case 1:
                                !1 !== t.sent() ? (l.default.debug("Showing notify button because display predicate returned true."), OneSignal.notifyButton.launcher.show()) : (l.default.debug("Hiding notify button because display predicate returned false."), OneSignal.notifyButton.launcher.hide()), t.label = 2;
                            case 2:
                                return [2]
                        }
                    })
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(e) {
                        switch (e.label) {
                            case 0:
                                return OneSignal.config.userConfig.promptOptions ? [4, d.CustomLink.initialize(OneSignal.config.userConfig.promptOptions.customlink)] : [3, 2];
                            case 1:
                                e.sent(), e.label = 2;
                            case 2:
                                return [2]
    ...
    var h = function() {
        function e() {}
        return e.getAppConfig = function(e, t) {
            return r(this, void 0, void 0, function() {
                var n, i, r;
                return o(this, function(o) {
                    switch (o.label) {
                        case 0:
                            if (o.trys.push([0, 2, , 3]), !e || !e.appId || !f.default.isValidUuid(e.appId)) throw new l.SdkInitError(l.SdkInitErrorKind.InvalidAppId);
                            return [4, t(e.appId)];
                        case 1:
                            return n = o.sent(), i = this.getMergedConfig(e, n), this.checkRestrictedOrigin(i), [2, i];
                        case 2:
                            if (r = o.sent()) {
        ...
        }, e.getIntegrationCapabilities = function(e) {
            switch (e) {
        ...
        }, e.getMergedConfig = function(e, t) {
        ...
        }, e.injectDefaultsIntoPromptOptions = function(e, t) {
            if (!e) return e;
            var n = e.customlink || {
                    enabled: void 0,
                    style: void 0,
            ...
            return i({}, e, {
                customlink: {
                    enabled: p.default.getValueOrDefault(n.enabled, r.enabled),
                    style: p.default.getValueOrDefault(n.style, r.style),
                    size: p.default.getValueOrDefault(n.size, r.size),
                    unsubscribeEnabled: p.default.getValueOrDefault(n.unsubscribeEnabled, r.unsubscribeEnabled),
                    text: {
                        subscribe: p.default.getValueOrDefault(n.text ? n.text.subscribe : void 0, r.text.subscribe),
                        unsubscribe: p.default.getValueOrDefault(n.text ? n.text.unsubscribe : void 0, r.text.unsubscribe),
                        explanation: p.default.getValueOrDefault(n.text ? n.text.explanation : void 0, r.text.explanation)
                    },
                    color: {
                        button: p.default.getValueOrDefault(n.color ? n.color.button : void 0, r.color.button),
                        text: p.default.getValueOrDefault(n.color ? n.color.text : void 0, r.color.text)
                    }
                }
            })
        }, e.getUserConfigForConfigIntegrationKind = function(e, n, r) {
            switch (this.getIntegrationCapabilities(e).configuration) {
                case t.IntegrationConfigurationKind.Dashboard:
                    return {
                        ...
                        persistNotification: r.config.notificationBehavior ? r.config.notificationBehavior.display.persist : void 0,
                        webhooks: {
                        ...
                        notificationClickHandlerMatch: r.config.notificationBehavior ? r.config.notificationBehavior.click.match : void 0,
                        notificationClickHandlerAction: r.config.notificationBehavior ? r.config.notificationBehavior.click.action : void 0,
                        allowLocalhostAsSecureOrigin: r.config.setupBehavior ? r.config.setupBehavior.allowLocalhostAsSecureOrigin : void 0,
        ...
        }, e.getSubdomainForConfigIntegrationKind = function(e, n, i) {
        ...
        }, e.shouldUseServerConfigSubdomain = function(e, n) {
    ...
    var a = n(36),
        ...
        d = function() {
            function e() {}
            return e.downloadServerAppConfig = function(e) {
                return r(this, void 0, void 0, function() {
                    return o(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return l.Utils.enforceAppId(e), [4, new Promise(function(t, n) {
                                    t(a.OneSignalApiBase.get("sync/" + e + "/web", null))
                                })];
                            case 1:
                                return [2, t.sent()]
                        }
            ...
            }, e.getUserIdFromSubscriptionIdentifier = function(e, t, n) {
                return l.Utils.enforceAppId(e), a.OneSignalApiBase.post("players", {
                    app_id: e,
                    device_type: t,
                    identifier: n,
                    notification_types: u.SubscriptionStateKind.TemporaryWebRecord
                }).then(function(e) {
                    return e && e.id ? e.id : null
                }).catch(function(e) {
                    return c.default.debug("Error getting user ID from subscription identifier:", e), null
                })
            }, e.updatePlayer = function(e, t, n) {
                return l.Utils.enforceAppId(e), l.Utils.enforcePlayerId(t), a.OneSignalApiBase.put("players/" + t, i({
                    app_id: e
                }, n))
            }, e
        }();
    t.OneSignalApiSW = d, t.default = d
}, function(e, t, n) {
    "use strict";
    var i = this && this.__awaiter || function(e, t, n, i) {
            return new(n || (n = Promise))(function(r, o) {
    ...
    var s = o(n(84)),
        ...
        d = function() {
            function e() {}
            return e.getPlayer = function(e, t) {
                return l.default.getPlayer(e, t)
            }, e.updatePlayer = function(e, t, n) {
                return l.default.updatePlayer(e, t, n)
            }, e.sendNotification = function(e, t, n, i, r, o, s, a) {
                return l.default.sendNotification(e, t, n, i, r, o, s, a)
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(n) {
                        switch (n.label) {
                            case 0:
                                return a.default.getWindowEnv() === u.WindowEnvironmentKind.ServiceWorker ? [3, 2] : [4, new Promise(function(n, i) {
                                    e.jsonpLib(a.default.getOneSignalApiUrl().toString() + "/sync/" + t + "/web", function(e, t) {
                            ...
                            case 1:
                                return [2, n.sent()];
                            case 2:
                                return [4, c.default.downloadServerAppConfig(t)];
                            case 3:
                                return [2, n.sent()]
                        }
                    })
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return [4, l.default.createUser(e)];
                            case 1:
                                return [2, t.sent()]
                        }
                    })
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return [4, l.default.createEmailRecord(e, t, n)];
                            case 1:
                                return [2, i.sent()]
                        }
                    })
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return [4, l.default.updateEmailRecord(e, t, n)];
                            case 1:
                                return [2, i.sent()]
                        }
                    })
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return [4, l.default.logoutEmail(e, t, n)];
                            case 1:
                                return [2, i.sent()]
                        }
                    })
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(n) {
                        switch (n.label) {
                            case 0:
                                return [4, l.default.updateUserSession(e, t)];
                            case 1:
                                return [2, n.sent()]
                        }
                    })
            ...
            return e.prototype.getAppConfig = function(e) {
                return i(this, void 0, void 0, function() {
                    return r(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return [4, a.ConfigHelper.getAppConfig(e, s.default.downloadServerAppConfig)];
                            case 1:
                                return [2, t.sent()]
                        }
                    })
                ...
                return a.ConfigHelper.getMergedConfig(e, t)
            }, e
        }();
    t.default = u
}, function(e, t, n) {
    ...
    var a = s(n(20)),
        ...
        g = function() {
            ...
            return e.prototype.getDeviceId = function() {
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return [4, f.default.getSubscription()];
                            case 1:
                                if (!(e = t.sent().deviceId)) throw new l.NotSubscribedError(l.NotSubscribedReason.NoDeviceId);
                                return [2, e]
                        }
                    })
                })
            }, e.prototype.createDeviceRecord = function() {
                return r(this, void 0, void 0, function() {
                    var e, t;
                    return o(this, function(n) {
                        switch (n.label) {
                            case 0:
                                return (e = new c.PushDeviceRecord).appId = this.context.appConfig.appId, t = e, [4, d.default.getCurrentNotificationType()];
                            case 1:
                                return t.subscriptionState = n.sent(), [2, e]
                        }
                    })
                })
            }, e.prototype.sendPlayerUpdate = function(e) {
                return r(this, void 0, void 0, function() {
                    var t;
                    return o(this, function(n) {
                        switch (n.label) {
                            case 0:
                                return [4, this.context.subscriptionManager.isAlreadyRegisteredWithOneSignal()];
                            case 1:
                                return n.sent() ? [4, this.getDeviceId()] : (p.default.debug("Not sending the update because user is not registered with OneSignal (no device id)"), [2]);
                            case 2:
                                return t = n.sent(), e ? [3, 4] : [4, this.createDeviceRecord()];
                            case 3:
                                e = n.sent(), n.label = 4;
                            case 4:
                                return this.onSessionSent ? [4, a.default.updatePlayer(this.context.appConfig.appId, t, i({
                                    notification_types: u.SubscriptionStateKind.Subscribed
                                }, e.serialize()))] : [3, 6];
                            case 5:
                                return n.sent(), [3, 8];
                            case 6:
                                return [4, this.sendOnSessionUpdate(e)];
                            case 7:
                                n.sent(), n.label = 8;
                            case 8:
                                return [2]
            ...
            }, e.prototype.sendOnSessionUpdate = function(e) {
                return r(this, void 0, void 0, function() {
                    var t, n;
                    return o(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return this.onSessionSent ? [2] : this.context.sessionManager.isFirstPageView() ? [4, this.context.subscriptionManager.isAlreadyRegisteredWithOneSignal()] : [2];
                            case 1:
                                return i.sent() ? [4, this.getDeviceId()] : (p.default.debug("Not sending the on session because user is not registered with OneSignal (no device id)"), [2]);
                            case 2:
                                return t = i.sent(), e ? [3, 4] : [4, this.createDeviceRecord()];
                            case 3:
                                e = i.sent(), i.label = 4;
                            case 4:
                                if (e.subscriptionState !== u.SubscriptionStateKind.Subscribed && !0 !== OneSignal.config.enableOnSession) return [2];
                                i.label = 5;
                            case 5:
                                return i.trys.push([5, 7, , 8]), [4, a.default.updateUserSession(t, e)];
                            case 6:
                                return i.sent(), this.onSessionSent = !0, [3, 8];
                            case 7:
                                return n = i.sent(), p.default.error('Failed to update user session. Error "' + n.message + '" ' + n.stack), [3, 8];
                            case 8:
                                return [2]
                        }
                    })
                })
            }, e.prototype.sendPlayerCreate = function(e) {
                return r(this, void 0, void 0, function() {
                    var t, n;
                    return o(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return i.trys.push([0, 2, , 3]), [4, a.default.createUser(e)];
                            case 1:
                                return (t = i.sent()) ? (p.default.info("Subscribed to web push and registered with OneSignal", e, t), this.onSessionSent = !0, [2, t]) : (p.default.error("Failed to create user."), [2, void 0]);
                            case 2:
                                return n = i.sent(), p.default.error('Failed to create user. Error "' + n.message + '" ' + n.stack), [2, void 0];
                            case 3:
                                return [2]
                        }
                    })
                })
            }, e.prototype.onSessionAlreadyCalled = function() {
                return this.onSessionSent
            }, e.prototype.sendExternalUserIdUpdate = function(e) {
                return r(this, void 0, void 0, function() {
                    var t;
                    return o(this, function(n) {
                        switch (n.label) {
                            ...
                            case 1:
                                return t = n.sent(), [4, a.default.updatePlayer(this.context.appConfig.appId, t, {
                                    external_user_id: h.default.getValueOrDefault(e, "")
                                })];
                            case 2:
                                return n.sent(), [2]
                        }
    ...
    var i = function() {
        ...
        return e.prototype.isNewSubscription = function() {
            ...
            return n.w3cP256dh = t.w3cP256dh, n.w3cAuth = t.w3cAuth, n.existingW3cPushSubscription = void 0, t.existingW3cPushSubscription ? n.existingW3cPushSubscription = e.deserialize(t.existingW3cPushSubscription) : t.existingPushSubscription && (n.existingW3cPushSubscription = e.deserialize(t.existingPushSubscription)), n.safariDeviceToken = t.safariDeviceToken, n.existingSafariDeviceToken = t.existingSafariDeviceToken, n
        }, e
    }();
    ...
    var r = n(32),
        ...
        u = function() {
            function e() {}
            return e.getServiceWorkerManager = function(e) {
                var t = e.appConfig,
                    n = a.default.getBuildEnvPrefix(),
                    i = {
                        workerAPath: new s.default("/" + n + "OneSignalSDKWorker.js"),
                        workerBPath: new s.default("/" + n + "OneSignalSDKUpdaterWorker.js"),
                        registrationOptions: {
                            scope: "/"
                        }
                    };
                return t.userConfig && (t.userConfig.path && (i.workerAPath = new s.default("" + t.userConfig.path + n + t.userConfig.serviceWorkerPath), i.workerBPath = new s.default("" + t.userConfig.path + n + t.userConfig.serviceWorkerUpdaterPath)), t.userConfig.serviceWorkerParam && (i.registrationOptions = t.userConfig.serviceWorkerParam)), new r.ServiceWorkerManager(e, i)
            }, e.getSubscriptionManager = function(e) {
                var t = e.appConfig,
                    n = {
                ...
                return new o.SubscriptionManager(e, n)
            }, e
        }();
    t.ContextHelper = u, t.default = u
}, function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
            ...
            return Object.defineProperty(e, "STORED_PERMISSION_KEY", {
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(n) {
                        switch (n.label) {
                            case 0:
                                return a.default.safari ? [2, e.getSafariNotificationPermission(t)] : s.default.isUsingSubscriptionWorkaround() ? [4, this.getOneSignalSubdomainNotificationPermission(t)] : [3, 2];
                            case 1:
                                return [2, n.sent()];
                            case 2:
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return t = s.default.redetectBrowserUserAgent(), (n = !t.safari && !t.firefox && e === l.NotificationPermission.Denied) ? (i = this.isCurrentFrameContextCrossOrigin()) ? [3, 2] : [4, d.default.isFrameContextInsecure()] : [3, 3];
                            case 1:
                                i = r.sent(), r.label = 2;
                            case 2:
                                n = i || s.default.isUsingSubscriptionWorkaround() || d.default.isInsecureOrigin(), r.label = 3;
                            case 3:
                                return [2, n]
                        }
                    })
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return [4, this.getNotificationPermission()];
                            case 1:
    ...
    var a = s(n(10)),
        ...
        W = function() {
            ...
            return e.storeInitialValues = function() {
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(o) {
                        switch (o.label) {
                            case 0:
                                return e = OneSignal.context, M.default.debug("Checking subscription expiration..."), [4, e.subscriptionManager.isSubscriptionExpiring()];
                            case 1:
                                return o.sent() ? [4, h.default.getIntegration()] : (M.default.debug("Subscription is not considered expired."), [2]);
                            case 2:
                                switch (t = o.sent(), n = h.default.getWindowEnv(), M.default.debug("Subscription is considered expiring. Current Integration:", t), t) {
                            ...
                            case 7:
                                return r = o.sent(), M.default.debug("Finished registering brand new subscription:", r), [3, 10];
                            case 8:
                            ...
                            case 12:
                                return o.sent(), M.default.debug("Unsubscribed expiring HTTP subscription by removing registration ID."), [3, 13];
                            case 13:
                                return [2]
                        }
                    })
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(u) {
                        switch (u.label) {
                            ...
                            case 1:
                                return u.sent(), [4, e.installNativePromptPermissionChangedHook()];
                            case 2:
                                return u.sent(), [4, t.permissionManager.getNotificationPermission(t.appConfig.safariWebId)];
                            case 3:
                                return u.sent() === p.NotificationPermission.Granted && (OneSignal.__doNotShowWelcomeNotification = !0), (n = navigator.serviceWorker && "https:" === window.location.protocol) ? [4, h.default.isFrameContextInsecure()] : [3, 5];
                            case 4:
                                n = !u.sent(), u.label = 5;
                            case 5:
                                if (!n) return [3, 11];
                                u.label = 6;
                            case 6:
                                return u.trys.push([6, 10, , 11]), [4, x.ServiceWorkerManager.getRegistration()];
                            case 7:
                                return (i = u.sent()) && i.active ? [4, t.serviceWorkerManager.establishServiceWorkerChannel()] : [3, 9];
                            case 8:
                                u.sent(), u.label = 9;
                            case 9:
                                return [3, 11];
                            case 10:
                                return s = u.sent(), M.default.error(s), [3, 11];
                            case 11:
                                return [4, e.processExpiringSubscriptions()];
                            case 12:
                                return u.sent(), !0 !== OneSignal.config.userConfig.autoRegister || D.OneSignalUtils.isUsingSubscriptionWorkaround() ? OneSignal.context.updateManager.sendOnSessionUpdate() : OneSignal.once("ON_SESSION", function() {
                                    return r(a, void 0, void 0, function() {
                                        return o(this, function(e) {
                                            return OneSignal.context.updateManager.sendOnSessionUpdate(), [2]
                                        })
                                    })
                                }), [4, Promise.all([e.showNotifyButton(), e.showPromptsFromWebConfigEditor(), e.updateEmailSessionCount(), t.cookieSyncer.install()])];
                            case 13:
                                return u.sent(), [4, d.default.trigger(OneSignal.EVENTS.SDK_INITIALIZED_PUBLIC)];
                            case 14:
                                return u.sent(), [2]
                        }
                    })
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(t) {
                        switch (t.label) {
                            ...
                            case 1:
                                return !1 !== t.sent() ? (OneSignal.notifyButton = new T.default(OneSignal.config.userConfig.notifyButton), OneSignal.notifyButton.create()) : M.default.debug("Notify button display predicate returned false so not showing the notify button."), [3, 3];
                            case 2:
                                OneSignal.notifyButton = new T.default(OneSignal.config.userConfig.notifyButton), OneSignal.notifyButton.create(), t.label = 3;
                            case 3:
                                return [2]
                        }
                    })
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return (e = OneSignal.context).sessionManager.isFirstPageView() ? [4, v.default.getEmailProfile()] : [3, 3];
                            case 1:
                                return (t = i.sent()).emailId ? ((n = new I.EmailDeviceRecord(t.emailAddress, t.emailAuthHash)).appId = e.appConfig.appId, [4, O.default.updateUserSession(t.emailId, n)]) : [3, 3];
                            case 2:
                                i.sent(), i.label = 3;
                            case 3:
                                return [2]
                    ...
                    return o(this, function(n) {
                        switch (n.label) {
                            ...
                            case 4:
                                n.sent(), n.label = 5;
                            case 5:
                                return e.userConfig.promptOptions ? [4, N.CustomLink.initialize(e.userConfig.promptOptions.customlink)] : [3, 7];
                            case 6:
                                n.sent(), n.label = 7;
                            case 7:
                                return [2]
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(n) {
                        switch (n.label) {
                            case 0:
                                return M.default.debug("Called %cinternalInit()", m.getConsoleStyle("code")), [4, (t = OneSignal.context).serviceWorkerManager.updateWorker()];
                            case 1:
                                return n.sent(), t.sessionManager.incrementPageViewCount(), a.default.safari && !1 === OneSignal.config.userConfig.autoRegister ? (M.default.debug("On Safari and autoregister is false, skipping sessionInit()."), d.default.trigger(OneSignal.EVENTS.SDK_INITIALIZED), [2]) : !1 !== OneSignal.config.userConfig.autoRegister || OneSignal.config.subdomain ? [3, 6] : (M.default.debug("Skipping internal init. Not auto-registering and no subdomain."), [4, OneSignal.privateIsPushNotificationsEnabled()]);
                            case 2:
                                return !n.sent() || m.isUsingSubscriptionWorkaround() ? [3, 4] : (M.default.info("Because the user is already subscribed and has enabled notifications, we will re-register their GCM token."), [4, y.default.registerForPush()]);
                            case 3:
                                n.sent(), n.label = 4;
                            case 4:
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(r) {
                        switch (r.label) {
                            ...
                            case 3:
                                return r.sent(), M.default.info("OneSignal: Set pageTitle to be '" + n + "'."), i = OneSignal.config, [4, v.default.put("Options", {
                                    key: "emailAuthRequired",
            ...
            }, e.finishSessionInit = function(e) {
                return r(this, void 0, void 0, function() {
                    return o(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return OneSignal._sessionInitAlreadyRunning = !1, e.__fromInit ? [4, d.default.trigger(OneSignal.EVENTS.SDK_INITIALIZED)] : [3, 2];
                            case 1:
                                t.sent(), t.label = 2;
                            case 2:
                                return [2]
            ...
            }, e.sessionInit = function(t) {
                return r(this, void 0, void 0, function() {
                    var n;
                    return o(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return t || (t = {}), M.default.debug("Called %csessionInit(" + JSON.stringify(t) + ")", m.getConsoleStyle("code")), OneSignal._sessionInitAlreadyRunning ? (M.default.debug("Returning from sessionInit because it has already been called."), [2]) : (OneSignal._sessionInitAlreadyRunning = !0, n = OneSignal.context.appConfig.appId, t.__fromRegister && t.modalPrompt ? (OneSignal.subscriptionModalHost = new b.default(n, t), [4, OneSignal.subscriptionModalHost.load()]) : [3, 3]);
                            case 1:
                                return i.sent(), [4, e.finishSessionInit(t)];
                            case 2:
                                return i.sent(), [2];
                            case 3:
                                return m.isUsingSubscriptionWorkaround() ? [3, 17] : t.__fromInit && S.default.wasHttpsNativePromptDismissed() ? (M.default.debug("OneSignal: Not automatically showing native HTTPS prompt because the user previously dismissed it."), [4, e.finishSessionInit(t)]) : [3, 5];
                            case 4:
                                return i.sent(), [2];
                            case 5:
                                return [4, OneSignal.internalIsOptedOut()];
                            case 6:
                                return i.sent() ? [3, 12] : !t.__fromRegister && !0 === OneSignal.config.userConfig.autoRegister && (a.default.chrome && Number(a.default.version) >= 63 && (a.default.tablet || a.default.mobile) || a.default.safari && Number(a.default.version) >= 12.1) ? [4, e.finishSessionInit(t)] : [3, 8];
                            case 7:
                                return i.sent(), OneSignal.privateShowHttpPrompt(), [3, 11];
                            case 8:
                                return [4, e.finishSessionInit(t)];
                            case 9:
                                return i.sent(), [4, y.default.registerForPush()];
                            case 10:
                                i.sent(), i.label = 11;
                            case 11:
                                return [3, 16];
                            case 12:
                                return t.__fromRegister ? [4, e.finishSessionInit(t)] : [3, 14];
                            case 13:
                                return i.sent(), OneSignal.setSubscription(!0), [3, 16];
                            case 14:
                                return [4, e.finishSessionInit(t)];
                            case 15:
                                i.sent(), i.label = 16;
                            case 16:
                                return d.default.trigger("ON_SESSION"), [2];
                            case 17:
                                return !0 !== OneSignal.config.userConfig.autoRegister && M.default.debug("OneSignal: Not automatically showing popover because autoRegister is not specifically true."), S.default.isHttpPromptAlreadyShown() && M.default.debug("OneSignal: Not automatically showing popover because it was previously shown in the same session."), !0 !== OneSignal.config.userConfig.autoRegister || S.default.isHttpPromptAlreadyShown() ? [3, 19] : [4, OneSignal.privateShowHttpPrompt().catch(function(e) {
                                    e instanceof c.InvalidStateError && e.reason === c.InvalidStateReason[c.InvalidStateReason.RedundantPermissionMessage] || e instanceof l.default || e instanceof u.default || e instanceof P.default ? M.default.debug("[Prompt Not Showing]", e) : M.default.info(e)
                                })];
                            case 18:
                                i.sent(), i.label = 19;
                            case 19:
                                return [4, e.finishSessionInit(t)];
                            case 20:
                                return i.sent(), d.default.trigger("ON_SESSION"), [2]
                        }
                    })
                })
            }, e.polyfillSafariFetch = function() {
                return r(this, void 0, void 0, function() {
                    var e;
                    return o(this, function(t) {
                        switch (t.label) {
                            case 0:
                                ...
                                M.default.debug("Loading fetch polyfill for Safari.."), t.label = 1;
                            case 1:
                                return t.trys.push([1, 3, , 4]), [4, (new E.DynamicResourceLoader).loadFetchPolyfill()];
                            case 2:
                                return t.sent(), M.default.debug("Done loading fetch polyfill."), [3, 4];
                            case 3:
                                return e = t.sent(), M.default.debug("Error loading fetch polyfill:", e), [3, 4];
                            case 4:
                                return [2]
                        }
                    })
            ...
            }, e.loadSubscriptionPopup = function(e) {
                return r(this, void 0, void 0, function() {
                    return o(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return OneSignal.subscriptionPopupHost = new R.default(OneSignal.proxyFrameHost.url, e), [4, OneSignal.subscriptionPopupHost.load()];
                            case 1:
                                return t.sent(), [2]
                        }
                    })
    ...
    var s = n(4),
        ...
        c = function() {
            ...
            return e.initialize = function(t) {
            ...
            }, e.initSubscribeElement = function(t, n, i) {
                n.text && n.text.subscribe && (i || (t.textContent = n.text.subscribe)), n.text && n.text.unsubscribe && i && (t.textContent = n.text.unsubscribe), e.setResetClass(t), e.setStateClass(t, i), e.setStyleClass(t, n), e.setSizeClass(t, n), e.setCustomColors(t, n), !0 !== n.unsubscribeEnabled && s.addCssClass(t, "hide"), t.setAttribute(e.subscriptionStateAttribute, i.toString()), e.isInitialized(t) || (t.addEventListener("click", function() {
                    u.default.info("CustomLink: subscribe clicked"), e.handleClick(t)
                }), e.markAsInitialized(t))
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(n) {
                        switch (n.label) {
                            ...
                            case 1:
                                return n.sent() ? [4, a.default.setSubscription(!1)] : [3, 3];
                            case 2:
                                n.sent(), n.label = 3;
                            case 3:
                                return [3, 6];
                            case 4:
                                return [4, a.default.registerForPushNotifications()];
                            case 5:
                                n.sent(), n.label = 6;
                            case 6:
                                return [2]
    ...
    var r = i(n(5)),
        o = function() {
            function e() {}
            return e.decodeHtmlEntities = function(t) {
                return r.default.isBrowser() && (e.decodeTextArea || (e.decodeTextArea = document.createElement("textarea"))), e.decodeTextArea ? (e.decodeTextArea.innerHTML = t, e.decodeTextArea.value) : t
            }, e
        }();
    t.BrowserUtils = o, o.decodeTextArea = null, t.default = o
}, function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    var i = function() {
        function e(e, t, n) {
            this.emailId = e, this.emailAddress = t, this.emailAuthHash = n
        }
        return e.prototype.serialize = function() {
            return {
            ...
            return new e(t.emailId, t.emailAddress, t.emailAuthHash)
        }, e
    }();
    t.EmailProfile = i
}, function(e, t, n) {
    ...
    var s = o(n(27)),
        ...
        c = function() {
            ...
            return e.prototype.open = function(e) {
                ...
                u.default.contains(t.message, "The operation failed for reasons unrelated to the database itself and not covered by any other error code") || u.default.contains(t.message, "A mutation operation was attempted on a database that did not allow mutations") ? a.default.warn("OneSignal: IndexedDb web storage is not available on this origin since this profile's IndexedDb schema has been upgraded in a newer version of Firefox. See: https://bugzilla.mozilla.org/show_bug.cgi?id=1236557#c6") : a.default.warn("OneSignal: Fatal error opening IndexedDb database:", t)
            }, e.prototype.onDatabaseError = function(e) {
                a.default.debug("IndexedDb: Generic database error", e.target.errorCode)
            }, e.prototype.onDatabaseOpenBlocked = function() {
                a.default.debug("IndexedDb: Blocked event")
            }, e.prototype.onDatabaseVersionChange = function(e) {
                a.default.debug("IndexedDb: versionchange event")
            }, e.prototype.onDatabaseUpgradeNeeded = function(e) {
                a.default.debug("IndexedDb: Database is being rebuilt or upgraded (upgradeneeded event).");
                                ...
                                return i.sent(), [4, new Promise(function(i, r) {
                                    try {
                                        ...
                                        o.onsuccess = function() {
                                            ...
                                            a.default.error("Database PUT Transaction Error:", e), r(e)
                                        }
                                    } catch (e) {
                                        a.default.error("Database PUT Error:", e), r(e)
                                    }
                                })];
                            case 2:
                                return [2, i.sent()]
                ...
                return new Promise(function(r, o) {
                    try {
                        ...
                        s.onsuccess = function() {
                            ...
                            a.default.error("Database REMOVE Transaction Error:", e), o(e)
                        }
                    } catch (e) {
                        a.default.error("Database REMOVE Error:", e), o(e)
                    }
                })
            }, e
        }();
        ...
        var a = s(n(10)),
            ...
            O = function() {
                ...
                return Object.defineProperty(e, "VERSION", {
                    ...
                    }), m.default.debug("Setting up message listeners."), e.workerMessenger.listen(), e.setupMessageListeners()
                }, e.getAppId = function() {
                    return r(this, void 0, void 0, function() {
                        var e;
                        return o(this, function(t) {
                            switch (t.label) {
                                case 0:
                                    return self.location.search && (e = self.location.search.match(/appId=([0-9a-z-]+)&?/i)) && e.length > 1 ? [2, e[1]] : [4, h.default.getAppConfig()];
                                case 1:
                                    return [2, t.sent().appId]
                            }
                        })
                    })
                    ...
                    e.workerMessenger.on(c.WorkerMessengerCommand.WorkerVersion, function(t) {
                        m.default.debug("[Service Worker] Received worker version message."), e.workerMessenger.broadcast(c.WorkerMessengerCommand.WorkerVersion, u.default.version())
                        ...
                        return r(t, void 0, void 0, function() {
                            ...
                            return o(this, function(o) {
                                switch (o.label) {
                                    case 0:
                                        return t = n, m.default.debug("[Service Worker] Received subscribe message."), [4, (i = new d.default(t)).subscriptionManager.subscribe(0)];
                                    case 1:
                        ...
                        return r(t, void 0, void 0, function() {
                            ...
                            return o(this, function(o) {
                                switch (o.label) {
                                    case 0:
                                        return t = n, m.default.debug("[Service Worker] Received subscribe new message."), [4, (i = new d.default(t)).subscriptionManager.subscribe(1)];
                                    case 1:
                                        return r = o.sent(), [4, i.subscriptionManager.registerSubscription(r)];
                                    case 2:
                        ...
                        return r(t, void 0, void 0, function() {
                            ...
                            return o(this, function(o) {
                                switch (o.label) {
                                    case 0:
                                        return m.default.debug("[Service Worker] Received AMP subscription state message."), [4, self.registration.pushManager.getSubscription()];
                                    case 1:
                                    ...
                                    case 3:
                                        return n = o.sent(), [4, h.default.getSubscription()];
                                    case 4:
                        ...
                        return r(t, void 0, void 0, function() {
                            ...
                            return o(this, function(o) {
                                switch (o.label) {
                                    case 0:
                                        return m.default.debug("[Service Worker] Received AMP subscribe message."), [4, e.getAppId()];
                                    case 1:
                                        return t = o.sent(), [4, S.ConfigHelper.getAppConfig({
                                            appId: t
                                        }, p.default.downloadServerAppConfig)];
                                    case 2:
                        ...
                        return r(t, void 0, void 0, function() {
                            ...
                            return o(this, function(i) {
                                switch (i.label) {
                                    case 0:
                                        return m.default.debug("[Service Worker] Received AMP unsubscribe message."), [4, e.getAppId()];
                                    case 1:
                                        return t = i.sent(), [4, S.ConfigHelper.getAppConfig({
                                            appId: t
                                        }, p.default.downloadServerAppConfig)];
                                    case 2:
                    ...
                    m.default.debug("Called %conPushReceived(" + JSON.stringify(t, null, 4) + "):", w.Utils.getConsoleStyle("code"), t), t.waitUntil(e.parseOrFetchNotifications(t).then(function(t) {
                        if (!t || 0 == t.length) return m.default.debug("Because no notifications were retrieved, we'll display the last known notification, so long as it isn't the welcome notification."), e.displayBackupNotification();
                        for (var n = [], i = 0, r = t; i < r.length; i++) {
                            var o = r[i];
                            m.default.debug("Raw Notification from OneSignal:", o);
                    ...
                    return r(this, void 0, void 0, function() {
                        ...
                        return o(this, function(o) {
                            switch (o.label) {
                                case 0:
                                    return [4, h.default.getSubscription()];
                                case 1:
                                    return n = o.sent().deviceId, [4, h.default.get("Options", "webhooks.cors")];
                                case 2:
                                    return i = o.sent(), [4, h.default.get("Options", "webhooks." + e)];
                                case 3:
                                    return (r = o.sent()) ? (s = {
                                        event: e,
                                        id: t.id,
                                    ...
                                    }), m.default.debug("Executing " + e + " webhook " + (i ? "with" : "without") + " CORS %cPOST " + r, w.Utils.getConsoleStyle("code"), ":", s), [4, fetch(r, a)]) : [3, 5];
                                case 4:
                                    return [2, o.sent()];
                                case 5:
                                    return [2]
                                ...
                                case 1:
                                    for (e = o.sent(), t = [], n = 0, i = e; n < i.length; n++) {
                                        if ((r = i[n]).frameType && "nested" === r.frameType) {
                                            if (!w.Utils.contains(r.url, l.default.getOneSignalApiUrl().host) && !w.Utils.contains(r.url, ".os.tc")) continue;
                    ...
                    return w.Utils.trimUndefined(t)
                    ...
                    return r(this, void 0, void 0, function() {
                        ...
                        return o(this, function(o) {
                            switch (o.label) {
                                case 0:
                                    return m.default.debug("Called %cdisplayNotification(" + JSON.stringify(t, null, 4) + "):", w.Utils.getConsoleStyle("code"), t), [4, e._getTitle()];
                                case 1:
                                    return r = o.sent(), [4, h.default.get("Options", "defaultIcon")];
                                case 2:
                                    return s = o.sent(), [4, h.default.get("Options", "persistNotification")];
                                case 3:
                    ...
                    return r(this, void 0, void 0, function() {
                        return o(this, function(t) {
                            switch (t.label) {
                                case 0:
                                    return e.data && e.data.__isOneSignalWelcomeNotification ? [2] : [4, h.default.put("Ids", {
                                        type: "backupNotification",
                                        id: e
                                    })];
                                case 1:
                    ...
                    return h.default.get("Ids", "backupNotification").then(function(t) {
                        var n = {
                    ...
                    return "javascript:void(0);" !== e && "do_not_open" !== e && !w.Utils.contains(e, "_osp=do_not_open")
                }, e.onNotificationClosed = function(t) {
                    m.default.debug("Called %conNotificationClosed(" + JSON.stringify(t, null, 4) + "):", w.Utils.getConsoleStyle("code"), t);
                    ...
                    return r(this, void 0, void 0, function() {
                        ...
                        return o(this, function(o) {
                            switch (o.label) {
                                case 0:
                                    return t = self.registration.scope, [4, h.default.getAppState()];
                                case 1:
                    ...
                    return r(this, void 0, void 0, function() {
                        var n, i, r, s, a, u, l, d, f, p, g, b, v, S, y, O, _, E, P, I, C, k, M;
                        return o(this, function(o) {
                            switch (o.label) {
                                case 0:
                                    return m.default.debug("Called %conNotificationClicked(" + JSON.stringify(t, null, 4) + "):", w.Utils.getConsoleStyle("code"), t), t.notification.close(), n = t.notification.data, t.action && (n.action = t.action), i = "exact", r = "navigate", [4, h.default.get("Options", "notificationClickHandlerMatch")];
                                case 1:
                                ...
                                case 4:
                                    return l = o.sent(), d = e.shouldOpenNotificationUrl(l), [4, h.default.getAppConfig()];
                                case 5:
                                    return f = o.sent().appId, [4, h.default.getSubscription()];
                                case 6:
                                    p = o.sent().deviceId, g = e.sendConvertedAPIRequests(f, p, n), b = !1, v = 0, S = u, o.label = 7;
                                case 7:
                                    return v < S.length ? (y = S[v], O = y.url, y.isSubdomainIframe ? [4, h.default.get("Options", "lastKnownHostUrl")] : [3, 10]) : [3, 39];
                                case 8:
                                    return _ = o.sent(), O = _, _ ? [3, 10] : [4, h.default.get("Options", "defaultUrl")];
                                case 9:
                                    O = o.sent(), o.label = 10;
                                case 10:
                                    E = "";
                                    try {
                                        ...
                                        m.default.error("Failed to get the HTTP site's actual origin:", e)
                                    }
                                    P = null;
                                    try {
                                        P = new URL(l).origin
                                    } catch (e) {}
                                    if (!("exact" === i && O === l || "origin" === i && E === P)) return [3, 38];
                                    if (!(y.isSubdomainIframe && O === l || !y.isSubdomainIframe && y.url === l || "focus" === r && E === P)) return [3, 15];
                                    e.workerMessenger.unicast(c.WorkerMessengerCommand.NotificationClicked, n, y), o.label = 11;
                                case 11:
                                    return o.trys.push([11, 13, , 14]), [4, y.focus()];
                                case 12:
                                    return o.sent(), [3, 14];
                                case 13:
                                    return I = o.sent(), m.default.error("Failed to focus:", y, I), [3, 14];
                                case 14:
                                    return [3, 37];
                                case 15:
                                    if (!y.isSubdomainIframe) return [3, 23];
                                    o.label = 16;
                                case 16:
                                    return o.trys.push([16, 18, , 19]), m.default.debug("Client is subdomain iFrame. Attempting to focus() client."), [4, y.focus()];
                                case 17:
                                    return o.sent(), [3, 19];
                                case 18:
                                    return C = o.sent(), m.default.error("Failed to focus:", y, C), [3, 19];
                                case 19:
                                    return d ? (m.default.debug("Redirecting HTTP site to " + l + "."), [4, h.default.put("NotificationOpened", {
                                        url: l,
                                        data: n,
                                        timestamp: Date.now()
                                    })]) : [3, 21];
                                case 20:
                                    return o.sent(), e.workerMessenger.unicast(c.WorkerMessengerCommand.RedirectPage, l, y), [3, 22];
                                case 21:
                                    m.default.debug("Not navigating because link is special."), o.label = 22;
                                case 22:
                                    return [3, 37];
                                case 23:
                                    if (!y.navigate) return [3, 34];
                                    o.label = 24;
                                case 24:
                                    return o.trys.push([24, 26, , 27]), m.default.debug("Client is standard HTTPS site. Attempting to focus() client."), [4, y.focus()];
                                case 25:
                                    return o.sent(), [3, 27];
                                case 26:
                                    return k = o.sent(), m.default.error("Failed to focus:", y, k), [3, 27];
                                case 27:
                                    return o.trys.push([27, 32, , 33]), d ? (m.default.debug("Redirecting HTTPS site to (" + l + ")."), [4, h.default.put("NotificationOpened", {
                                        url: l,
                                        data: n,
                                        timestamp: Date.now()
                                    })]) : [3, 30];
                                case 28:
                                    return o.sent(), [4, y.navigate(l)];
                                case 29:
                                    return o.sent(), [3, 31];
                                case 30:
                                    m.default.debug("Not navigating because link is special."), o.label = 31;
                                case 31:
                                    return [3, 33];
                                case 32:
                                    return M = o.sent(), m.default.error("Failed to navigate:", y, l, M), [3, 33];
                                case 33:
                                    return [3, 37];
                                case 34:
                                    return [4, h.default.put("NotificationOpened", {
                                        url: l,
                                        data: n,
                                        timestamp: Date.now()
                                    })];
                                ...
                                case 38:
                                    return v++, [3, 7];
                                case 39:
                                    return !d || b ? [3, 42] : [4, h.default.put("NotificationOpened", {
                                        url: l,
                                        data: n,
                                        timestamp: Date.now()
                                    })];
                ...
                }, e.sendConvertedAPIRequests = function(t, n, i) {
                    return r(this, void 0, void 0, function() {
                        var r;
                        return o(this, function(o) {
                            switch (o.label) {
                                case 0:
                                    return i.id ? (t ? r = f.default.put("notifications/" + i.id, {
                                        app_id: t,
                                        player_id: n,
                                        opened: !0
                                    }) : console.error("No app Id, skipping OneSignal API call for notification open!"), [4, e.executeWebhooks("notification.clicked", i)]) : (console.error("No notification id, skipping networks calls to report open!"), [2]);
                                case 1:
                                    return o.sent(), r ? [4, r] : [3, 3];
                                case 2:
                                    o.sent(), o.label = 3;
                                case 3:
                                    return [2]
                    ...
                    return r(this, void 0, void 0, function() {
                        ...
                        return o(this, function(n) {
                            switch (n.label) {
                                case 0:
                                    m.default.debug("Opening notification URL:", e), n.label = 1;
                                case 1:
                                    return n.trys.push([1, 3, , 4]), [4, self.clients.openWindow(e)];
                                case 2:
                                    return [2, n.sent()];
                                case 3:
                                    return t = n.sent(), m.default.warn("Failed to open the URL '" + e + "':", t), [2, void 0];
                                case 4:
                                    return [2]
                            }
                        })
                    ...
                    m.default.info("%cOneSignal Service Worker activated (version " + u.default.version() + ", " + l.default.getWindowEnv().toString() + " environment).", w.Utils.getConsoleStyle("bold")), e.waitUntil(self.clients.claim())
                }, e.onPushSubscriptionChange = function(t) {
                    return r(this, void 0, void 0, function() {
                        var n, i, r, s, a, u, c, l, f;
                        return o(this, function(o) {
                            switch (o.label) {
                                case 0:
                                    return m.default.debug("Called %conPushSubscriptionChange(" + JSON.stringify(t, null, 4) + "):", w.Utils.getConsoleStyle("code"), t), [4, e.getAppId()];
                                case 1:
                                    return (n = o.sent()) ? [4, S.ConfigHelper.getAppConfig({
                                        appId: n
                                    }, p.default.downloadServerAppConfig)] : [2];
                                case 2:
                                    return (i = o.sent()) ? (r = new d.default(i), [4, h.default.getSubscription()]) : [2];
                                case 3:
                                    return a = o.sent().deviceId, (s = !!a) || !t.oldSubscription ? [3, 7] : [4, p.default.getUserIdFromSubscriptionIdentifier(n, v.PushDeviceRecord.prototype.getDeliveryPlatform(), t.oldSubscription.endpoint)];
                                case 4:
                                    return a = o.sent(), [4, h.default.getSubscription()];
                                case 5:
                                    return (u = o.sent()).deviceId = a, [4, h.default.setSubscription(u)];
                                case 6:
                                    o.sent(), o.label = 7;
                                case 7:
                                    return s = !!a, (l = t.newSubscription) ? (c = g.RawPushSubscription.setFromW3cSubscription(l), [3, 11]) : [3, 8];
                                case 8:
                                ...
                                case 10:
                                    return o.sent(), [3, 11];
                                case 11:
                                    return s || !!c ? [3, 14] : [4, h.default.remove("Ids", "userId")];
                                case 12:
                                    return o.sent(), [4, h.default.remove("Ids", "registrationId")];
                                case 13:
                                    return o.sent(), [3, 17];
                                case 14:
                                    return f = null, [4, navigator.permissions.query({
                                        name: "push",
                                        userVisibleOnly: !0
                                    })];
                                case 15:
                                    return "granted" !== o.sent() ? f = b.SubscriptionStateKind.PermissionRevoked : c || (f = b.SubscriptionStateKind.PushSubscriptionRevoked), [4, r.subscriptionManager.registerSubscription(c, f)];
                                case 16:
                                    o.sent(), o.label = 17;
                                case 17:
                                    return [2]
                    ...
                    return new Promise(function(e) {
                        Promise.all([h.default.get("Options", "defaultTitle"), h.default.get("Options", "pageTitle")]).then(function(t) {
                            var n = t[0],
                                i = t[1];
                            e(null !== n ? n : null != i ? i : "")
                        })
                    ...
                    return t.data ? e.isValidPushPayload(t.data) ? (m.default.debug("Received a valid encrypted push payload."), Promise.resolve([t.data.json()])) : Promise.reject("Unexpected push message payload received: " + t.data.text()) : e.retrieveNotifications()
                }, e.isValidPushPayload = function(e) {
                    try {
                        var t = e.json();
                        return !!(t && t.custom && t.custom.i && y.OneSignalUtils.isValidUuid(t.custom.i)) || (m.default.debug("isValidPushPayload: Valid JSON but missing notification UUID:", t), !1)
                    } catch (e) {
                        return m.default.debug("isValidPushPayload: Parsing to JSON failed with:", e), !1
                    }
                }, e.retrieveNotifications = function() {
                    return new Promise(function(t) {
                        var n = [];
                        h.default.get("Ids", "userId").then(function(t) {
                            return t ? (m.default.debug("Legacy push signal received, retrieving contents from players/" + t + "/chromeweb_notification"), f.default.get("players/" + t + "/chromeweb_notification")) : (m.default.debug("Tried to get notification contents, but IndexedDB is missing user ID info."), Promise.all([e.getAppId(), self.registration.pushManager.getSubscription().then(function(e) {
                                return e.endpoint
                            })]).then(function(e) {
                                var t = e[0],
                                    n = e[1],
                                    i = v.PushDeviceRecord.prototype.getDeliveryPlatform();
                                return p.default.getUserIdFromSubscriptionIdentifier(t, i, n).then(function(e) {
                                    return e ? (m.default.debug("Recovered OneSignal user ID:", e), Promise.all([h.default.put("Ids", {
                                        type: "userId",
                                        id: e
                                    }), h.default.put("Ids", {
                                        type: "registrationId",
                                        ...
                                        return m.default.debug("Attempting to retrieve the notification again now with a recovered user ID."), f.default.get("players/" + e + "/chromeweb_notification")
                                    })) : Promise.reject("Recovered user ID was null. Unsubscribing from push notifications.")
                                })
                            }).catch(function(t) {
                                return m.default.debug("Unsuccessfully attempted to recover OneSignal user ID:", t), self.registration.pushManager.getSubscription().then(function(e) {
                                    return e.unsubscribe()
                                }).then(function(t) {
                                    m.default.debug("Unsubscribed from push notifications result:", t), e.UNSUBSCRIBED_FROM_NOTIFICATIONS = !0
                                })
                            }))
                        }).then(function(e) {
                            for (var i = 0; i < e.length; i++) n.push(JSON.parse(e[i]));
                            0 == n.length && m.default.warn("OneSignal Worker: Received a GCM push signal, but there were no messages to retrieve. Are you using the wrong API URL?", l.default.getOneSignalApiUrl().toString()), t(n)
                        })
                    })
                }, e
            }();
        t.ServiceWorker = O, "undefined" == typeof self && void 0 !== e ? e.OneSignalWorker = O : self.OneSignalWorker = O, "undefined" != typeof self && O.run()
    }).call(this, n(70))
}, function(e, t, n) {
    "use strict";
    var i, r = this && this.__extends || (i = Object.setPrototypeOf || {
    ...
    var s = o(n(10)),
        ...
        l = function() {
            function e(e) {
                e || (e = u.default.getSlidedownPermissionMessageOptions()), this.options = e, this.options.actionMessage = e.actionMessage.substring(0, 90), this.options.acceptButtonText = e.acceptButtonText.substring(0, 15), this.options.cancelButtonText = e.cancelButtonText.substring(0, 15), this.notificationIcons = null
            }
            return Object.defineProperty(e, "EVENTS", {
                get: function() {
                    return {
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return null !== this.notificationIcons ? [3, 2] : [4, u.default.getNotificationIcons()];
                            case 1:
                                t = r.sent(), this.notificationIcons = t, this.container && c.removeDomElement("#onesignal-popover-container"), n = this.getPlatformNotificationIcon(), i = '<div id="normal-popover"><div class="popover-body"><div class="popover-body-icon"><img alt="notification icon" class="' + ("default-icon" === n ? "default-icon" : "") + '" src="' + ("default-icon" === n ? "data:image/svg+xml;charset=utf-8,%3Csvg%20width%3D%2239.5%22%20height%3D%2240.5%22%20viewBox%3D%220%200%2079%2081%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Ctitle%3EOneSignal-Bell%3C%2Ftitle%3E%3Cg%20fill%3D%22%23BBB%22%20fill-rule%3D%22evenodd%22%3E%3Cpath%20d%3D%22M39.96%2067.12H4.12s-3.2-.32-3.2-3.36%202.72-3.2%202.72-3.2%2010.72-5.12%2010.72-8.8c0-3.68-1.76-6.24-1.76-21.28%200-15.04%209.6-26.56%2021.12-26.56%200%200%201.6-3.84%206.24-3.84%204.48%200%206.08%203.84%206.08%203.84%2011.52%200%2021.12%2011.52%2021.12%2026.56s-1.6%2017.6-1.6%2021.28c0%203.68%2010.72%208.8%2010.72%208.8s2.72.16%202.72%203.2c0%202.88-3.36%203.36-3.36%203.36H39.96zM27%2070.8h24s-1.655%2010.08-11.917%2010.08S27%2070.8%2027%2070.8z%22%2F%3E%3C%2Fg%3E%3C%2Fsvg%3E" : n) + '"></div><div class="popover-body-message">' + this.options.actionMessage + '</div><div class="clearfix"></div></div><div class="popover-footer"><button id="onesignal-popover-allow-button" class="align-right primary popover-button">' + this.options.acceptButtonText + '</button><button id="onesignal-popover-cancel-button" class="align-right secondary popover-button">' + this.options.cancelButtonText + '</button><div class="clearfix"></div></div></div>', c.addDomElement("body", "beforeend", '<div id="onesignal-popover-container" class="onesignal-popover-container onesignal-reset"></div>'), c.addDomElement(this.container, "beforeend", '<div id="onesignal-popover-dialog" class="onesignal-popover-dialog">' + i + "</div>"), c.addCssClass(this.container, s.default.mobile ? "slide-up" : "slide-down"), this.allowButton.addEventListener("click", this.onPopoverAllowed.bind(this)), this.cancelButton.addEventListener("click", this.onPopoverCanceled.bind(this)), a.default.trigger(e.EVENTS.SHOWN), r.label = 2;
                            case 2:
                                return [2]
                        }
                    })
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return [4, a.default.trigger(e.EVENTS.ALLOW_CLICK)];
                            case 1:
                                return t.sent(), [2]
                        }
                    })
                ...
                a.default.trigger(e.EVENTS.CANCEL_CLICK), this.close()
            }, e.prototype.close = function() {
                var t = this;
                c.addCssClass(this.container, "close-popover"), c.once(this.dialog, "animationend", function(n, i) {
                    n.target !== t.dialog || "slideDownExit" !== n.animationName && "slideUpExit" !== n.animationName || (c.removeDomElement("#onesignal-popover-container"), i(), a.default.trigger(e.EVENTS.CLOSED))
                }, !0)
            }, e.prototype.getPlatformNotificationIcon = function() {
                return this.notificationIcons ? c.isChromeLikeBrowser() || s.default.firefox || s.default.msedge ? this.notificationIcons.chrome ? this.notificationIcons.chrome : this.notificationIcons.firefox ? this.notificationIcons.firefox : "default-icon" : s.default.safari ? this.notificationIcons.safari ? this.notificationIcons.safari : this.notificationIcons.chrome ? this.notificationIcons.chrome : "default-icon" : void 0 : "default-icon"
            }, Object.defineProperty(e.prototype, "container", {
                get: function() {
            ...
            return e.isSafari = function() {
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                switch (n = h.default.getWindowEnv()) {
                                    ...
                                    case m.WindowEnvironmentKind.OneSignalProxyFrame:
                                        throw new w.InvalidStateError(w.InvalidStateReason.UnsupportedEnvironment)
                                }
                                switch (n) {
                            ...
                            case 2:
                                return i = r.sent(), [3, 10];
                            case 3:
                                return [4, OneSignal.privateGetNotificationPermission()];
                            case 4:
                                if (r.sent() === g.NotificationPermission.Denied) throw new O.default(_.PushPermissionNotGrantedErrorReason.Blocked);
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return t && (t = b.RawPushSubscription.deserialize(t)), i = S.PushDeviceRecord.createFromPushSubscription(this.config.appId, t, n), o = void 0, [4, this.isAlreadyRegisteredWithOneSignal()];
                            case 1:
                                return r.sent() ? [4, this.context.updateManager.sendPlayerUpdate(i)] : [3, 3];
                            case 2:
                                return r.sent(), [3, 6];
                            case 3:
                                return [4, this.context.updateManager.sendPlayerCreate(i)];
                            case 4:
                                return (o = r.sent()) ? [4, this.associateSubscriptionWithEmail(o)] : [3, 6];
                            case 5:
                                r.sent(), r.label = 6;
                            case 6:
                                return [4, a.default.getSubscription()];
                            case 7:
                                return (s = r.sent()).deviceId = o, s.optedOut = !1, t ? e.isSafari() ? s.subscriptionToken = t.safariDeviceToken : s.subscriptionToken = t.w3cEndpoint ? t.w3cEndpoint.toString() : null : s.subscriptionToken = null, [4, a.default.setSubscription(s)];
                            case 8:
                                return r.sent(), h.default.getWindowEnv() !== m.WindowEnvironmentKind.ServiceWorker && d.default.trigger(OneSignal.EVENTS.REGISTERED), "undefined" != typeof OneSignal && (OneSignal._sessionInitAlreadyRunning = !1), [2, s]
                        }
                    })
                })
                    ...
                    return r(this, function(n) {
                        switch (n.label) {
                            case 0:
                                ...
                                throw new k.default;
                            case 1:
                                return 1 !== e ? [3, 7] : h.default.getWindowEnv() !== m.WindowEnvironmentKind.ServiceWorker ? [3, 5] : [4, a.default.getSubscription()];
                            case 2:
                                return t = n.sent().deviceId, [4, u.default.updatePlayer(this.context.appConfig.appId, t, {
                                    notification_types: v.SubscriptionStateKind.MutedByApi
                                })];
                            case 3:
                                return n.sent(), [4, a.default.put("Options", {
                                    key: "optedOut",
                                    value: !0
                                })];
                            case 4:
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(n) {
                        switch (n.label) {
                            case 0:
                                return [4, a.default.getEmailProfile()];
                            case 1:
                                return (t = n.sent()).emailId ? [4, u.default.updatePlayer(this.config.appId, e, {
                                    parent_player_id: t.emailId,
                ...
                var e = this;
                return new Promise(function(t) {
                    window.safari.pushNotification.requestPermission(h.default.getOneSignalApiUrl().toString() + "/safari", e.config.safariWebId, {
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(i) {
                        switch (i.label) {
                            case 0:
                                if (e = new b.RawPushSubscription, !this.config.safariWebId) throw new E.SdkInitError(E.SdkInitErrorKind.MissingSafariWebId);
                                return t = window.safari.pushNotification.permission(this.config.safariWebId).deviceToken, e.existingSafariDeviceToken = t, t || d.default.trigger(OneSignal.EVENTS.PERMISSION_PROMPT_DISPLAYED), [4, this.subscribeSafariPromptPermission()];
                            case 1:
                                if (n = i.sent(), M.PermissionUtils.triggerNotificationPermissionChanged(), !n) throw new P.default(I.SubscriptionErrorReason.InvalidSafariSetup);
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return h.default.getWindowEnv() === m.WindowEnvironmentKind.ServiceWorker || window.Notification.permission !== g.NotificationPermission.Default ? [3, 5] : [4, d.default.trigger(OneSignal.EVENTS.PERMISSION_PROMPT_DISPLAYED)];
                            case 1:
                                return r.sent(), [4, e.requestPresubscribeNotificationPermission()];
                            case 2:
                                return (n = r.sent()) !== g.NotificationPermission.Default ? [3, 4] : [4, M.PermissionUtils.triggerNotificationPermissionChanged(!0)];
                            case 3:
                                r.sent(), r.label = 4;
                            case 4:
                                switch (n) {
                                    case g.NotificationPermission.Default:
                                        throw f.default.debug("Exiting subscription and not registering worker because the permission was dismissed."), OneSignal._sessionInitAlreadyRunning = !1, OneSignal._isRegisteringForPush = !1, new O.default(_.PushPermissionNotGrantedErrorReason.Dismissed);
                                    case g.NotificationPermission.Denied:
                                        throw f.default.debug("Exiting subscription and not registering worker because the permission was blocked."), OneSignal._sessionInitAlreadyRunning = !1, OneSignal._isRegisteringForPush = !1, new O.default(_.PushPermissionNotGrantedErrorReason.Blocked)
                                }
                                r.label = 5;
                            case 5:
                            ...
                            case 8:
                                return r.sent(), [3, 14];
                            case 9:
                                return (i = r.sent()) instanceof C.default ? 403 !== i.status ? [3, 11] : [4, this.context.subscriptionManager.registerFailedSubscription(v.SubscriptionStateKind.ServiceWorkerStatus403, this.context)] : [3, 13];
                            case 10:
                                return r.sent(), [3, 13];
                            case 11:
                                return 404 !== i.status ? [3, 13] : [4, this.context.subscriptionManager.registerFailedSubscription(v.SubscriptionStateKind.ServiceWorkerStatus404, this.context)];
                            case 12:
                                r.sent(), r.label = 13;
                            case 13:
                                throw i;
                            case 14:
                                return f.default.debug("Waiting for the service worker to activate..."), [4, navigator.serviceWorker.ready];
                            case 15:
                                return o = r.sent(), f.default.debug("Service worker is ready to continue subscribing."), [4, this.subscribeFcmVapidOrLegacyKey(o.pushManager, t)];
                            case 16:
                                return [2, r.sent()]
                        }
                    })
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(n) {
                        switch (n.label) {
                            case 0:
                                if (!self.registration.active && !s.default.firefox) throw new w.InvalidStateError(w.InvalidStateReason.ServiceWorkerNotActivated);
                                return [4, self.registration.pushManager.permissionState({
                                    userVisibleOnly: !0
                                })];
                            case 1:
                                if ("denied" === (t = n.sent())) throw new O.default(_.PushPermissionNotGrantedErrorReason.Blocked);
                                if ("prompt" === t) throw new O.default(_.PushPermissionNotGrantedErrorReason.Default);
                ...
                var e = void 0;
                return (e = s.default.firefox ? this.config.onesignalVapidPublicKey : this.config.vapidPublicKey) ? A.base64ToUint8Array(e).buffer : void 0
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 1:
                                ...
                                return [3, 9];
                            case 2:
                                return o && o.options ? (f.default.debug("[Subscription Manager] An existing push subscription exists and options is not null. Using existing options to resubscribe."), n = o.options, s = !1, [3, 5]) : [3, 3];
                            case 3:
                                return !o || o.options ? [3, 5] : (f.default.debug("[Subscription Manager] An existing push subscription exists and options is null. Unsubscribing from push first now."), [4, o.unsubscribe()]);
                            case 4:
                                r.sent(), s = !1, r.label = 5;
                            case 5:
                                return [3, 9];
                            case 6:
                                return o ? (f.default.debug("[Subscription Manager] Unsubscribing existing push subscription."), [4, o.unsubscribe()]) : [3, 8];
                            case 7:
                                r.sent(), r.label = 8;
                            case 8:
                                return s = !0, [3, 9];
                            case 9:
                                return f.default.debug("[Subscription Manager] Subscribing to web push with these options:", n), [4, e.subscribe(n)];
                            case 10:
                                return i = r.sent(), s ? [4, a.default.getSubscription()] : [3, 13];
                            case 11:
                                return (u = r.sent()).createdAt = (new Date).getTime(), u.expirationTime = i.expirationTime, [4, a.default.setSubscription(u)];
                            case 12:
                                r.sent(), r.label = 13;
                            case 13:
                                return c = b.RawPushSubscription.setFromW3cSubscription(i), o && (c.existingW3cPushSubscription = b.RawPushSubscription.setFromW3cSubscription(o)), [2, c]
                        }
                    })
                })
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return [4, h.default.getIntegration()];
                            case 1:
                                switch (e = r.sent(), t = h.default.getWindowEnv(), e) {
                                    case y.IntegrationKind.Secure:
                                        return [3, 2];
                                    case y.IntegrationKind.SecureProxy:
                                        return [3, 4];
                                    case y.IntegrationKind.InsecureProxy:
                                        return [3, 10]
                                }
                                return [3, 12];
                            case 2:
                            ...
                            case 4:
                                ...
                                throw new w.InvalidStateError(w.InvalidStateReason.NoProxyFrame);
                            case 5:
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return [4, this.context.serviceWorkerManager.getActiveState()];
                            case 1:
                                return (e = r.sent()) !== p.ServiceWorkerActiveState.WorkerA && e !== p.ServiceWorkerActiveState.WorkerB ? [2, !1] : [4, c.ServiceWorkerManager.getRegistration()];
                            case 2:
                                return (t = r.sent()) && t.pushManager ? [4, t.pushManager.getSubscription()] : [2, !1];
                            case 3:
                                return (n = r.sent()) && n.expirationTime ? [4, a.default.getSubscription()] : [2, !1];
                            case 4:
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                ...
                                switch (t = h.default.getWindowEnv(), t) {
                                    case m.WindowEnvironmentKind.ServiceWorker:
                                        return [3, 1]
                                }
                                return [3, 4];
                            ...
                            case 2:
                                return n = r.sent(), [4, a.default.getSubscription()];
                            case 3:
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return [4, a.default.getSubscription()];
                            case 1:
                                return t = r.sent(), n = t.deviceId, i = t.optedOut, e.isSafari() ? (o = window.safari.pushNotification.permission(this.config.safariWebId), [2, {
                                    subscribed: !("granted" !== o.permission || !o.deviceToken || !n),
                                    optedOut: !!i
                                }]) : [4, this.context.serviceWorkerManager.getActiveState()];
                            case 2:
                                return s = r.sent(), [4, c.ServiceWorkerManager.getRegistration()];
                            case 3:
                                return u = r.sent(), [4, this.context.permissionManager.getNotificationPermission(this.context.appConfig.safariWebId)];
                            case 4:
                                return l = r.sent(), d = s === p.ServiceWorkerActiveState.WorkerA || s === p.ServiceWorkerActiveState.WorkerB, u ? [2, {
                                    subscribed: !(!n || l !== g.NotificationPermission.Granted || !d),
                                    optedOut: !!i
                                }] : [2, {
                                    subscribed: !1,
                                    optedOut: !!i
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 2:
                                return o = r.sent(), [2, {
                                    subscribed: !(!t || !n || o !== g.NotificationPermission.Granted),
                                    optedOut: !!i
                                }]
                        }
                    })
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(n) {
                        return t.sessionManager.isFirstPageView() && (t.subscriptionManager.registerSubscription(new b.RawPushSubscription, e), t.sessionManager.incrementPageViewCount()), [2]
                    })
                })
            }, e
        }();
    t.SubscriptionManager = T
}, function(e, t, n) {
    "use strict";
    var i = this && this.__awaiter || function(e, t, n, i) {
            return new(n || (n = Promise))(function(r, o) {
    ...
    var s = o(n(1)),
        a = function() {
            function e(e, t) {
                void 0 === t && (t = !1), this.context = e, this.isFeatureEnabled = t
            }
            ...
            return r(t, e), t.prototype.getPlatformNotificationIcon = function() {
                ...
                return OneSignal.getSubscription().then(function(t) {
                    ...
                    if (e.bell.options.showCredit && (i = '<div class="divider"></div><div class="kickback">Powered by <a href="https://onesignal.com" class="kickback" target="_blank">OneSignal</a></div>'), e.bell.state === d.default.STATES.SUBSCRIBED && !0 === t || e.bell.state === d.default.STATES.UNSUBSCRIBED && !1 === t) {
                        ...
                        var l = null;
                        s.default.chrome ? s.default.mobile || s.default.tablet || (l = "/bell/chrome-unblock.jpg") : s.default.firefox ? l = "/bell/firefox-unblock.jpg" : s.default.safari ? l = "/bell/safari-unblock.jpg" : s.default.msedge && (l = "/bell/edge-unblock.png");
                        var f = "";
                        l && (f = '<a href="' + (l = u.default.getOneSignalApiUrl().origin + l) + '" target="_blank"><img src="' + l + '"></a></div>'), (s.default.mobile || s.default.tablet) && s.default.chrome && (f = "<ol><li>Access <strong>Settings</strong> by tapping the three menu dots <strong>â‹®</strong></li><li>Click <strong>Site settings</strong> under Advanced.</li><li>Click <strong>Notifications</strong>.</li><li>Find and click this entry for this website.</li><li>Click <strong>Notifications</strong> and set it to <strong>Allow</strong>.</li></ol>"), n = "<h1>" + e.bell.text["dialog.blocked.title"] + '</h1><div class="divider"></div><div class="instructions"><p>' + e.bell.text["dialog.blocked.message"] + "</p>" + f + "</div>" + i
                    }
    ...
    t.oneSignalSdkInit = function() {
        ...
        var e;
        if ("undefined" != typeof OneSignal && (e = OneSignal), s.isPushNotificationsSupported() ? window.OneSignal = n(17).default : (o.default.debug("OneSignal: Push notifications are not supported. A stubbed version of the SDK will be initialized."), window.OneSignal = r.default), e) {
    ...
    var r = n(101),
        o = n(3);
    i(n(1)).default.getWindowEnv() === o.WindowEnvironmentKind.ServiceWorker ? self.OneSignal = n(75) : r.oneSignalSdkInit()
}]);
